...
<head>
	<meta charset="UTF-8">
	<title>MultiPurpose - Ultra Customizable Premium Responsive Website Template</title>
...
<body class="home"><div class="root">
	<header class="h13">
		...
		<section class="main-header">
			<p class="title"><a href="./"><img src="images/temp/logo.png" alt="MultiPurpose"></a> Ultra Customizable Template</p>
			<nav class="social">
				<ul>
			...
			<nav class="mainmenu">
				<ul>
					<li class="current-menu-item"><a href="./">Home</a>
						<ul>
							...
							<li class="current-menu-item"><a href="./home5.html">Hotel</a></li>
					...
					<li><a href="#">Sliders</a>
						<ul>		
							<li><a href="./home4.html">Best Slider</a></li>
							<li><a href="./home8.html">Premium Slider</a></li>
							<li><a href="./landing-page.html">Landing Slider</a></li>
							<li><a href="./home5.html">Form Slider</a></li>
							<li><a href="./home9a.html">Content Slider</a></li>
							<li><a href="./home9.html">Modern Slider</a></li>
					...
					<li><a href="./portfolio-multiple.html">Potfolio</a>
						<ul>
				...
				<select id="sec-nav" name="sec-nav">
					...
					<option value="./home5.html" selected="selected">- Hotel</option>
	...
	<section class="slider5 p01">
		<div>
			<div class="slider">
				<article>
					<div class="img-border"><img src="images/temp/96.jpg" alt=""></div>
					<h3>Some description of the content</h3>
				</article>
				<article>
					<div class="img-border"><img src="images/temp/96-2.jpg" alt=""></div>
					<h3>Other text</h3>
				</article>
				<article>
					<div class="img-border"><img src="images/temp/96-3.jpg" alt=""></div>
					<h3>Content, content, content everywhere</h3>
				</article>
				<article>
					<div class="img-border"><img src="images/temp/96-4.jpg" alt=""></div>
					<h3>Some reading</h3>
				</article>
				<article>
					<div class="img-border"><img src="images/temp/96-5.jpg" alt=""></div>
					<h3>Good news!</h3>
				</article>
			</div>
			<form action="send-header-form.php" method="post">
				...
				<p class="input"><input name="shc-name" id="shc-name" placeholder="Name"></p><p class="input"><input name="shc-lastname" id="shc-lastname" placeholder="Last Name"></p><p class="input"><input name="shc-email" id="shc-email" placeholder="Email"></p><p class="input"><input name="shc-phone" id="shc-phone" placeholder="Phone"></p>
	...
	<section class="content">
		<section class="main">
			<article class="intro">
				<h1><strong>Welcome</strong> cum sociis natoque penatibus et magnis dis parturient montes</h1>
			...
			<section class="latest">
				<h2><span>What do we offer</span></h2>
				<article class="post">
					<div class="alignleft"><img src="images/temp/86.jpg" alt=""></div>
					<h3><a href="#">Cum sociis natoque penatibus et magnis?</a></h3>
				...
				<article>
					<div class="alignleft"><img src="images/temp/87.jpg" alt=""></div>
					<h3><a href="#">Etiam rhoncus. Maecenas tempus</a></h3>
					<p>Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.</p>
				</article>
				<article>
					<div class="alignleft"><img src="images/temp/88.jpg" alt=""></div>
					<h3><a href="#">Sem quam semper libero, sit amet</a></h3>
					<p>Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem.</p>
				</article>
			</section>
		...
		<aside>
			<section>
				...
				<table>
					...
					<tr>
						<td>Totam rem aperiam</td>
						<td>20 - 30 $</td>
					</tr>
					<tr>
						<td>Magnam aliquam quaerat</td>
						<td>30 - 40 $</td>
					</tr>
					<tr>
					...
					<tr>
						<td>Cupiditate non provident</td>
						<td>50 - 60 $</td>
					</tr>
					<tr>
						<td>Eligendi optio</td>
						<td>60 - 70 $</td>
					</tr>
				</table>
				...
				<blockquote class="quote">
					...
					<p class="signature">- <span>Michael Brown</span> / SDC Industry Inc.</p>
				</blockquote>
			</section><section>
				...
				<ul class="tick">
					...
					<li>laboriosam, nisi ut aliquid ex ea commodi</li>
					<li>cupiditate non provident</li>
	...
	<footer>
		<section class="widgets"><article>
				...
				<p>MultiPurpose Ltd.<br>330 Super High<br>Suite 700<br>New York<br>Phone: +1 123 123 1234<br>E-mail: <a href="mailto:contact@example.com">contact@example.com</a></p>
		...
		<section class="bottom">
			<p><a href="http://themeforest.net/item/multipurpose-responsive-html5-website-template/5379349?ref=ThemeMotive">MultiPurpose</a> template created by <a href="http://thememotive.com/">ThemeMotive</a> | All rights reserved</p>
			<nav class="social">
				<ul>
					<li><a href="#" class="facebook">Facebook</a></li>
					<li><a href="#" class="twitter">Twitter</a></li>
