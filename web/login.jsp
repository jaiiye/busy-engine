...
<body class="login">
    ...
    <div class="logo">
        <a href="index.html">
        <img src="../images-site/<%= Database.getLoginHeaderImage() %>" alt=""/>        
        </a>
    </div>
    <!-- END LOGO -->
    ...
    <div class="content">
        ...
        <form class="login-form" action="j_security_check" method="post">
            ...
            <div class="alert alert-danger display-hide">
                ...
                <%
				 ...
				 {		
				%>
					Invalid Username or Password: <%= request.getParameter("msg")%>	
				<%
				}
				%>
                </span>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn blue-hoki pull-right">
            ...
            <div class="forget-password">
                ...
                <p>
                     Click <a href="javascript:;" id="forget-password"> here </a> to reset your password.
                </p>
            </div>
            <div class="create-account">
                <p>
                     Don't have an account?&nbsp; <a href="javascript:;" id="register-btn"> Create an account </a>
                </p>
            </div>
        </form>
        <!-- END LOGIN FORM -->
        ...
        <form class="register-form" action="index.html" method="post">
            ...
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Security Question</label>
                <select name="securityQuestion" id="select2_sec" class="select2 form-control">
                    <option value=""></option>
            ...
            <div class="form-group">
                <label class="control-label visible-ie8 visible-ie9">Security Answer</label>
                <div class="input-icon">
                    <i class="fa fa-lightbulb-o"></i>
                    <input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="type answer here" name="securityAnswer"/>
                </div>
            </div>
            <div class="form-group">
                <label>
            ...
            <div class="form-actions">
                ...
                <button type="submit" id="register-submit-btn" class="btn blue-hoki pull-right">Sign Up <i class="m-icon-swapright m-icon-white"></i></button>
            </div>
        </form>
		...
		<script>
			...
			{     
				...
				$('.login-form').validate({
					...
					messages: {
						j_username: { required: "Username is required." },
						j_password: { required: "Password is required." }
					},
				...
				//handle Register
				$("#select2_sec").select2({
					placeholder: '<i class="fa fa-question"></i>&nbsp;Select a Question',
					allowClear: false,
					escapeMarkup: function (m) {
						return m;
					}
				...
				$('.register-form').validate({
					...
					messages: { 
						tnc: { required: "Please accept Terms and Cnditions first." }
					},
					...
					errorPlacement: function (error, element) {
						if      (element.attr("name") == "tnc") { error.insertAfter($('#register_tnc_error')); } 
						else if (element.closest('.input-icon').size() === 1) { error.insertAfter(element.closest('.input-icon')); } 
