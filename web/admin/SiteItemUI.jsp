...
{
    site_itemList = new SiteItemDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    site_itemList = new SiteItemDaoImpl().findAll(null, null);
}
request.setAttribute("site_itemList", site_itemList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "SiteItem"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> SiteItem </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="SiteItemUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="SiteItemId" ${param.column == 'SiteItemId' ? "selected" : "" } >SiteItemId</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'SiteItemUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="site_item" items="${site_itemList}" >
                        <div class="row" id="itemBox${site_item.siteItemId}" style="display:${param.id == null ? "none" : site_item.siteItemId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${site_item.siteItemId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=site_item&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="siteItemId">SiteItem:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteItemId" class="form-control" value="${site_item.siteItemId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteId" class="form-control" value="${site_item.siteId}" />
                                                        <select name="siteId" class="form-control">
                                                            <%SiteItem x = (SiteItem) pageContext.getAttribute("site_item"); %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="itemId" class="form-control" value="${site_item.itemId}" />
                        ...
                        <!-- BEGIN MODAL NEW SiteItem FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new SiteItem</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=site_item&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">SiteItemId</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="siteItemId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("site_item", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>SiteItem Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="site_item" items="${site_itemList}" >
                                                <tr>                                                    
                                                    <td>${site_item.siteItemId}</td> 
                                                    <td>${site_item.siteId}</td> 
                                                    <td>${site_item.itemId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${site_item.siteItemId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${site_item.siteItemId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${site_item.siteItemId}").button().click(function() {
                                                        toggleVisibility('itemBox${site_item.siteItemId}');                                                        
                                                        document.getElementById('itemBox${site_item.siteItemId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${site_item.siteItemId}").button().click(function() {
                                                        window.location = '../Operations?form=site_item&action=3&id=${site_item.siteItemId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=site_item&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    ignore: "",
                    rules: {                                
                        siteItemId:    { required: true, number: true }, 
