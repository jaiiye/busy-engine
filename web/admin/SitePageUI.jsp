...
{
    site_pageList = new SitePageDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    site_pageList = new SitePageDaoImpl().findAll(null, null);
}
request.setAttribute("site_pageList", site_pageList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "SitePage"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> SitePage </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="SitePageUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="SitePageId" ${param.column == 'SitePageId' ? "selected" : "" } >SitePageId</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'SitePageUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="site_page" items="${site_pageList}" >
                        <div class="row" id="itemBox${site_page.sitePageId}" style="display:${param.id == null ? "none" : site_page.sitePageId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${site_page.sitePageId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=site_page&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="sitePageId">SitePage:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="sitePageId" class="form-control" value="${site_page.sitePageId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteId" class="form-control" value="${site_page.siteId}" />
                                                        <select name="siteId" class="form-control">
                                                            <%SitePage x = (SitePage) pageContext.getAttribute("site_page"); %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="pageId" class="form-control" value="${site_page.pageId}" />
                                                        <select name="pageId" class="form-control">
                                                            <%SitePage x = (SitePage) pageContext.getAttribute("site_page"); %>
                                                            <%= Database.generateSelectOptionsFromTableAndColumn("page", x.getPageId().toString(), 2)%>
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW SitePage FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new SitePage</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=site_page&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">SitePageId</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="sitePageId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("site_page", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>SitePage Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="1">SiteId</label> 
                                                    <label><input type="checkbox" checked data-column="2">PageId</label> 
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="site_page" items="${site_pageList}" >
                                                <tr>                                                    
                                                    <td>${site_page.sitePageId}</td> 
                                                    <td>${site_page.siteId}</td> 
                                                    <td>${site_page.pageId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${site_page.sitePageId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${site_page.sitePageId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${site_page.sitePageId}").button().click(function() {
                                                        toggleVisibility('itemBox${site_page.sitePageId}');                                                        
                                                        document.getElementById('itemBox${site_page.sitePageId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${site_page.sitePageId}").button().click(function() {
                                                        window.location = '../Operations?form=site_page&action=3&id=${site_page.sitePageId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=site_page&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    ignore: "",
                    rules: {                                
                        sitePageId:    { required: true, number: true }, 
