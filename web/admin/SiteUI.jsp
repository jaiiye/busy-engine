...
{
    siteList = new SiteDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    siteList = new SiteDaoImpl().findAll(null, null);
}
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "Site"); %>
        <%@include file="index_sidebar.jsp"%>
            ...
            <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="SiteUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="SiteId" ${param.column == 'SiteId' ? "selected" : "" } >SiteId</option>                                                            
                                                           <option value="SiteName" ${param.column == 'SiteName' ? "selected" : "" } >SiteName</option>                                                            
                                                           <option value="Domain" ${param.column == 'Domain' ? "selected" : "" } >Domain</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'SiteUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <div class="row" id="itemBox${site.siteId}" style="display:${param.id == null ? "none" : site.siteId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${site.siteId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=site&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="siteId">Site:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteId" class="form-control" value="${site.siteId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteName" class="form-control maxlength-handler" maxlength="100" value="${site.siteName}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="domain" class="form-control maxlength-handler" maxlength="255" value="${site.domain}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="mode" class="form-control" value="${site.mode}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="url" class="form-control maxlength-handler" maxlength="255" value="${site.url}" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="logoTitle">LogoTitle:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="logoTitle" class="form-control maxlength-handler" maxlength="100" value="${site.logoTitle}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="siteStatus">SiteStatus:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteStatus" class="form-control" value="${site.siteStatus}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="locale" class="form-control maxlength-handler" maxlength="100" value="${site.locale}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="templateId" class="form-control" value="${site.templateId}" />
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=site&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">SiteName</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="siteName" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="100" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="domain" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="255" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="mode" class="form-control" placeholder="Enter Integer" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">LogoTitle</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="logoTitle" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="100" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">UseAsStore</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">SiteStatus</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="siteStatus" class="form-control" placeholder="Enter Integer" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="locale" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="100" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>Site Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="2">Domain</label> 
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td>
                                                        ...
                                                        <button id="delete-item${site.siteId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${site.siteId}").button().click(function() {
                                                        toggleVisibility('itemBox${site.siteId}');                                                        
                                                        document.getElementById('itemBox${site.siteId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${site.siteId}").button().click(function() {
                                                        window.location = '../Operations?form=site&action=3&id=${site.siteId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=site&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    rules: {                                
                        ...
                        siteName:    { required: true, minlength: 1, maxlength: 100}, 
                        domain:    { required: true, minlength: 1, maxlength: 255}, 
