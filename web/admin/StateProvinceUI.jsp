...
{
    state_provinceList = new StateProvinceDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    state_provinceList = new StateProvinceDaoImpl().findAll(null, null);
}
request.setAttribute("state_provinceList", state_provinceList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "StateProvince"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> StateProvince </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="StateProvinceUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                           ...
                                                           <option value="Abbreviation" ${param.column == 'Abbreviation' ? "selected" : "" } >Abbreviation</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'StateProvinceUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="state_province" items="${state_provinceList}" >
                        <div class="row" id="itemBox${state_province.stateProvinceId}" style="display:${param.id == null ? "none" : state_province.stateProvinceId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${state_province.stateProvinceId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=state_province&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="stateProvinceId">StateProvince:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="stateProvinceId" class="form-control" value="${state_province.stateProvinceId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="name" class="form-control maxlength-handler" maxlength="100" value="${state_province.name}" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="abbreviation">Abbreviation:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="abbreviation" class="form-control maxlength-handler" maxlength="10" value="${state_province.abbreviation}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="countryId" class="form-control" value="${state_province.countryId}" />
                                                        <select name="countryId" class="form-control">
                                                            <%StateProvince x = (StateProvince) pageContext.getAttribute("state_province"); %>
                        ...
                        <!-- BEGIN MODAL NEW StateProvince FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new StateProvince</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=state_province&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">Abbreviation</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="abbreviation" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="10" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <!-- END MODAL NEW StateProvince FORM-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>StateProvince Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="2">Abbreviation</label> 
                                                    <label><input type="checkbox" checked data-column="3">CountryId</label> 
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="state_province" items="${state_provinceList}" >
                                                <tr>                                                    
                                                    <td>${state_province.stateProvinceId}</td> 
                                                    <td>${state_province.name}</td> 
                                                    <td>${state_province.abbreviation}</td> 
                                                    <td>${state_province.countryId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${state_province.stateProvinceId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${state_province.stateProvinceId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${state_province.stateProvinceId}").button().click(function() {
                                                        toggleVisibility('itemBox${state_province.stateProvinceId}');                                                        
                                                        document.getElementById('itemBox${state_province.stateProvinceId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${state_province.stateProvinceId}").button().click(function() {
                                                        window.location = '../Operations?form=state_province&action=3&id=${state_province.stateProvinceId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=state_province&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    rules: {                                
                        ...
                        abbreviation:    { required: true, minlength: 1, maxlength: 10}, 
