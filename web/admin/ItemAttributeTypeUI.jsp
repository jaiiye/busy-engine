...
{
    item_attribute_typeList = new ItemAttributeTypeDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    item_attribute_typeList = new ItemAttributeTypeDaoImpl().findAll(null, null);
}
request.setAttribute("item_attribute_typeList", item_attribute_typeList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "ItemAttributeType"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> ItemAttributeType </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="ItemAttributeTypeUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="ItemAttributeTypeId" ${param.column == 'ItemAttributeTypeId' ? "selected" : "" } >ItemAttributeTypeId</option>                                                            
                                                           <option value="AttributeName" ${param.column == 'AttributeName' ? "selected" : "" } >AttributeName</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'ItemAttributeTypeUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="item_attribute_type" items="${item_attribute_typeList}" >
                        <div class="row" id="itemBox${item_attribute_type.itemAttributeTypeId}" style="display:${param.id == null ? "none" : item_attribute_type.itemAttributeTypeId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${item_attribute_type.itemAttributeTypeId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=item_attribute_type&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="itemAttributeTypeId">ItemAttributeType:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="itemAttributeTypeId" class="form-control" value="${item_attribute_type.itemAttributeTypeId}" />

                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="attributeName">AttributeName:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="attributeName" class="form-control maxlength-handler" maxlength="45" value="${item_attribute_type.attributeName}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="description" class="form-control maxlength-handler" maxlength="255" value="${item_attribute_type.description}" />
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW ItemAttributeType FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new ItemAttributeType</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=item_attribute_type&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">AttributeName</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="attributeName" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="45" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <!-- END MODAL NEW ItemAttributeType FORM-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>ItemAttributeType Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="1">AttributeName</label> 
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="item_attribute_type" items="${item_attribute_typeList}" >
                                                <tr>                                                    
                                                    <td>${item_attribute_type.itemAttributeTypeId}</td> 
                                                    <td>${item_attribute_type.attributeName}</td> 
                                                    <td>${item_attribute_type.description}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${item_attribute_type.itemAttributeTypeId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${item_attribute_type.itemAttributeTypeId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${item_attribute_type.itemAttributeTypeId}").button().click(function() {
                                                        toggleVisibility('itemBox${item_attribute_type.itemAttributeTypeId}');                                                        
                                                        document.getElementById('itemBox${item_attribute_type.itemAttributeTypeId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${item_attribute_type.itemAttributeTypeId}").button().click(function() {
                                                        window.location = '../Operations?form=item_attribute_type&action=3&id=${item_attribute_type.itemAttributeTypeId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=item_attribute_type&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    rules: {                                
                        ...
                        attributeName:    { required: true, minlength: 1, maxlength: 45}, 
