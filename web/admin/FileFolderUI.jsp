...
{
    file_folderList = new FileFolderDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    file_folderList = new FileFolderDaoImpl().findAll(null, null);
}
request.setAttribute("file_folderList", file_folderList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "FileFolder"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> FileFolder </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="FileFolderUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="FileFolderId" ${param.column == 'FileFolderId' ? "selected" : "" } >FileFolderId</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'FileFolderUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="file_folder" items="${file_folderList}" >
                        <div class="row" id="itemBox${file_folder.fileFolderId}" style="display:${param.id == null ? "none" : file_folder.fileFolderId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${file_folder.fileFolderId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=file_folder&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="fileFolderId">FileFolder:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="fileFolderId" class="form-control" value="${file_folder.fileFolderId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteFileId" class="form-control" value="${file_folder.siteFileId}" />
                                                        <select name="siteFileId" class="form-control">
                                                            <%FileFolder x = (FileFolder) pageContext.getAttribute("file_folder"); %>
                                                            <%= Database.generateSelectOptionsFromTableAndColumn("site_file", x.getSiteFileId().toString(), 2)%>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteFolderId" class="form-control" value="${file_folder.siteFolderId}" />
                                                        <select name="siteFolderId" class="form-control">
                                                            <%FileFolder x = (FileFolder) pageContext.getAttribute("file_folder"); %>
                                                            <%= Database.generateSelectOptionsFromTableAndColumn("site_folder", x.getSiteFolderId().toString(), 2)%>
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW FileFolder FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new FileFolder</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=file_folder&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">FileFolderId</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="fileFolderId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("file_folder", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>FileFolder Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="1">SiteFileId</label> 
                                                    <label><input type="checkbox" checked data-column="2">SiteFolderId</label> 
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="file_folder" items="${file_folderList}" >
                                                <tr>                                                    
                                                    <td>${file_folder.fileFolderId}</td> 
                                                    <td>${file_folder.siteFileId}</td> 
                                                    <td>${file_folder.siteFolderId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${file_folder.fileFolderId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${file_folder.fileFolderId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${file_folder.fileFolderId}").button().click(function() {
                                                        toggleVisibility('itemBox${file_folder.fileFolderId}');                                                        
                                                        document.getElementById('itemBox${file_folder.fileFolderId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${file_folder.fileFolderId}").button().click(function() {
                                                        window.location = '../Operations?form=file_folder&action=3&id=${file_folder.fileFolderId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=file_folder&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    ignore: "",
                    rules: {                                
                        fileFolderId:    { required: true, number: true }, 
