...
{
    user_actionList = UserAction.getAllUserActionByColumn(request.getParameter("column"), request.getParameter("columnValue"));
}
else
{
    user_actionList = UserAction.getAllUserAction();
}
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                           ...
                                                           <option value="ActionDate" ${param.column == 'ActionDate' ? "selected" : "" } >ActionDate</option>                                                            
                                                           <option value="ActionTypeId" ${param.column == 'ActionTypeId' ? "selected" : "" } >ActionTypeId</option>                                                            
                                                           <option value="ActionDetail" ${param.column == 'ActionDetail' ? "selected" : "" } >ActionDetail</option>                                                            
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>User Action Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right"> 
                                                    <label><input type="checkbox" checked data-column="0">User</label> 
                                                    <label><input type="checkbox" checked data-column="1">Date</label> 
                                                    <label><input type="checkbox" checked data-column="2">Details</label> 
                                    	...
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td>${user_action.actionDate}</td> 
                                                    <td>${user_action.actionDetail}</td>                                                     
                                                    <td>
            ...
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    rules: {                                
                        ...
                        actionDate:    { required: true }, 
                        actionTypeId:    { required: true, number: true }, 
                        actionDetail:    { required: true, minlength: 1, maxlength: 65535} 
