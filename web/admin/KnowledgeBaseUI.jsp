...
{
    knowledge_baseList = new KnowledgeBaseDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    knowledge_baseList = new KnowledgeBaseDaoImpl().findAll(null, null);
}
request.setAttribute("knowledge_baseList", knowledge_baseList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "KnowledgeBase"); %>
        <%@include file="index_sidebar.jsp"%>
            ...
            <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="KnowledgeBaseUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="KnowledgeBaseId" ${param.column == 'KnowledgeBaseId' ? "selected" : "" } >KnowledgeBaseId</option>                                                            
                                                           <option value="KnowledgeBaseName" ${param.column == 'KnowledgeBaseName' ? "selected" : "" } >KnowledgeBaseName</option>                                                            
                                                           ...
                                                           <option value="LatestTopic" ${param.column == 'LatestTopic' ? "selected" : "" } >LatestTopic</option>                                                            
                                                           <option value="LatestPost" ${param.column == 'LatestPost' ? "selected" : "" } >LatestPost</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'KnowledgeBaseUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="knowledge_base" items="${knowledge_baseList}" >
                        <div class="row" id="itemBox${knowledge_base.knowledgeBaseId}" style="display:${param.id == null ? "none" : knowledge_base.knowledgeBaseId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${knowledge_base.knowledgeBaseId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=knowledge_base&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="knowledgeBaseId">KnowledgeBase:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="knowledgeBaseId" class="form-control" value="${knowledge_base.knowledgeBaseId}" />

                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="knowledgeBaseName">KnowledgeBaseName:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="knowledgeBaseName" class="form-control maxlength-handler" maxlength="200" value="${knowledge_base.knowledgeBaseName}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <textarea name="description" class="ckeditor form-control" rows="4">${knowledge_base.description}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="rank" class="form-control" value="${knowledge_base.rank}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <div class="input-group date form_datetime" data-date="2012-12-21T15:25:00Z">        <input type="text" name="lastModified" value="${knowledge_base.lastModified}" class="form-control">        <span class="input-group-btn">                <button class="btn default date-reset" type="button"><i class="fa fa-times"></i></button>        </span>        <span class="input-group-btn">                <button class="btn default date-set" type="button"><i class="fa fa-calendar"></i></button>        </span></div>
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="latestTopic">LatestTopic:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="latestTopic" class="form-control" value="${knowledge_base.latestTopic}" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="latestPost">LatestPost:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="latestPost" class="form-control" value="${knowledge_base.latestPost}" />
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW KnowledgeBase FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new KnowledgeBase</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=knowledge_base&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">KnowledgeBaseName</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="knowledgeBaseName" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="200" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">LatestTopic</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="latestTopic" class="form-control" placeholder="Enter Integer" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">LatestPost</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="latestPost" class="form-control" placeholder="Enter Integer" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <!-- END MODAL NEW KnowledgeBase FORM-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>KnowledgeBase Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="4">LastModified</label> 
                                                    <label><input type="checkbox" checked data-column="5">LatestTopic</label> 
                                                    <label><input type="checkbox" checked data-column="6">LatestPost</label> 
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="knowledge_base" items="${knowledge_baseList}" >
                                                <tr>                                                    
                                                    <td>${knowledge_base.knowledgeBaseId}</td> 
                                                    <td>${knowledge_base.knowledgeBaseName}</td> 
                                                    <td>${knowledge_base.description}</td> 
                                                    <td>${knowledge_base.rank}</td> 
                                                    <td>${knowledge_base.lastModified}</td> 
                                                    <td>${knowledge_base.latestTopic}</td> 
                                                    <td>${knowledge_base.latestPost}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${knowledge_base.knowledgeBaseId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${knowledge_base.knowledgeBaseId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${knowledge_base.knowledgeBaseId}").button().click(function() {
                                                        toggleVisibility('itemBox${knowledge_base.knowledgeBaseId}');                                                        
                                                        document.getElementById('itemBox${knowledge_base.knowledgeBaseId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${knowledge_base.knowledgeBaseId}").button().click(function() {
                                                        window.location = '../Operations?form=knowledge_base&action=3&id=${knowledge_base.knowledgeBaseId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=knowledge_base&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    rules: {                                
                        ...
                        knowledgeBaseName:    { required: true, minlength: 1, maxlength: 200}, 
                        description:    { required: true, minlength: 1, maxlength: 65535}, 
                        rank:    { required: true, number: true }, 
                        lastModified:    { required: true }, 
                        latestTopic:    { required: true, number: true }, 
                        latestPost:    { required: true, number: true } 
