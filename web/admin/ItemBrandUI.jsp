...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "brands"); %>
                            ...
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${item_brand.itemBrandId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
