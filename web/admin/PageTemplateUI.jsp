...
{
    page_templateList = new PageTemplateDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    page_templateList = new PageTemplateDaoImpl().findAll(null, null);
}
request.setAttribute("page_templateList", page_templateList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "PageTemplate"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> PageTemplate </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="PageTemplateUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="PageTemplateId" ${param.column == 'PageTemplateId' ? "selected" : "" } >PageTemplateId</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'PageTemplateUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="page_template" items="${page_templateList}" >
                        <div class="row" id="itemBox${page_template.pageTemplateId}" style="display:${param.id == null ? "none" : page_template.pageTemplateId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${page_template.pageTemplateId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=page_template&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="pageTemplateId">PageTemplate:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="pageTemplateId" class="form-control" value="${page_template.pageTemplateId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="name" class="form-control maxlength-handler" maxlength="45" value="${page_template.name}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <textarea name="markup" class="ckeditor form-control" rows="4">${page_template.markup}</textarea>
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW PageTemplate FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new PageTemplate</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=page_template&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">PageTemplateId</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="pageTemplateId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("page_template", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="name" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="45" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <!-- END MODAL NEW PageTemplate FORM-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>PageTemplate Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="page_template" items="${page_templateList}" >
                                                <tr>                                                    
                                                    <td>${page_template.pageTemplateId}</td> 
                                                    <td>${page_template.name}</td> 
                                                    <td>${page_template.markup}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${page_template.pageTemplateId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${page_template.pageTemplateId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${page_template.pageTemplateId}").button().click(function() {
                                                        toggleVisibility('itemBox${page_template.pageTemplateId}');                                                        
                                                        document.getElementById('itemBox${page_template.pageTemplateId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${page_template.pageTemplateId}").button().click(function() {
                                                        window.location = '../Operations?form=page_template&action=3&id=${page_template.pageTemplateId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=page_template&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    ignore: "",
                    rules: {                                
                        pageTemplateId:    { required: true, number: true }, 
                        name:    { required: true, minlength: 1, maxlength: 45}, 
