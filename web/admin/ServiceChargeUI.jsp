                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> ServiceCharge </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="ServiceChargeUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'ServiceChargeUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <div class="row" id="itemBox${service_charge.serviceChargeId}" style="display:${param.id == null ? "none" : service_charge.serviceChargeId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${service_charge.serviceChargeId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                        ...
                        <!-- BEGIN MODAL NEW ServiceCharge FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new ServiceCharge</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=service_charge&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                        ...
                        <!-- END MODAL NEW ServiceCharge FORM-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>ServiceCharge Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td>
                                                        ...
                                                        <button id="delete-item${service_charge.serviceChargeId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${service_charge.serviceChargeId}").button().click(function() {
                                                        toggleVisibility('itemBox${service_charge.serviceChargeId}');                                                        
                                                        document.getElementById('itemBox${service_charge.serviceChargeId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${service_charge.serviceChargeId}").button().click(function() {
                                                        window.location = '../Operations?form=service_charge&action=3&id=${service_charge.serviceChargeId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=service_charge&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
