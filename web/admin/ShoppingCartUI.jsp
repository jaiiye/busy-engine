...
<%
ArrayList<ShoppingCart> shopping_cartList = new ArrayList<ShoppingCart>();
if (request.getParameter("column") != null && request.getParameter("columnValue") != null)
{
    shopping_cartList = ShoppingCart.getAllShoppingCartByColumn(request.getParameter("column"), request.getParameter("columnValue"));
}
else
{
    shopping_cartList = ShoppingCart.getAllShoppingCart();
}
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "ShoppingCart"); %>
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <h3 class="page-title"> ShoppingCart </h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="ShoppingCartUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'ShoppingCartUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <c:forEach var="shopping_cart" items="${shopping_cartList}" >
                        <div class="row" id="itemBox${shopping_cart.shoppingCartId}" style="display:${param.id == null ? "none" : shopping_cart.shoppingCartId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${shopping_cart.shoppingCartId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=shopping_cart&action=2" method="post">

                                                <input type="hidden" name="shoppingCartId" value="${shopping_cart.shoppingCartId}" />
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="customerId">Customer:</label>
                                                    <div  class="col-md-10">
                                                        <select name="customerId" class="form-control">
                                                            <%ShoppingCart x = (ShoppingCart) pageContext.getAttribute("shopping_cart"); %>
                        ...
                        <!-- BEGIN MODAL NEW ShoppingCart FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new ShoppingCart</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=shopping_cart&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="customerId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("table_name:Customer", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="orderId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("table_name:Order", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <!-- END MODAL NEW ShoppingCart FORM-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>ShoppingCart Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="shopping_cart" items="${shopping_cartList}" >
                                                <tr>                                                    
                                                    <td>${shopping_cart.shoppingCartId}</td> 
                                                    <td>${shopping_cart.customerId}</td> 
                                                    <td>${shopping_cart.orderId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${shopping_cart.shoppingCartId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${shopping_cart.shoppingCartId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${shopping_cart.shoppingCartId}").button().click(function() {
                                                        toggleVisibility('itemBox${shopping_cart.shoppingCartId}');                                                        
                                                        document.getElementById('itemBox${shopping_cart.shoppingCartId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${shopping_cart.shoppingCartId}").button().click(function() {
                                                        window.location = '../Operations?form=shopping_cart&action=3&id=${shopping_cart.shoppingCartId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=shopping_cart&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
