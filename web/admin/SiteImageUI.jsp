...
{
    site_imageList = new SiteImageDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    site_imageList = new SiteImageDaoImpl().findAll(null, null);
}
request.setAttribute("site_imageList", site_imageList);
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="SiteImageUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="SiteImageId" ${param.column == 'SiteImageId' ? "selected" : "" } >SiteImageId</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'SiteImageUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
     ...
     <div class="portlet-title">
                        ...
                        <c:forEach var="site_image" items="${site_imageList}" >
                        <div class="row" id="itemBox${site_image.siteImageId}" style="display:${param.id == null ? "none" : site_image.siteImageId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${site_image.siteImageId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=site_image&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="siteImageId">SiteImage:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="siteImageId" class="form-control" value="${site_image.siteImageId}" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="fileName" class="form-control maxlength-handler" maxlength="255" value="${site_image.fileName}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="description" class="form-control maxlength-handler" maxlength="255" value="${site_image.description}" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="linkUrl">LinkUrl:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="linkUrl" class="form-control maxlength-handler" maxlength="255" value="${site_image.linkUrl}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="rank" class="form-control" value="${site_image.rank}" />
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW SiteImage FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new SiteImage</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=site_image&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>SiteImage Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="3">LinkUrl</label> 
                                                    <label><input type="checkbox" checked data-column="4">Rank</label> 
                                                    <label><input type="checkbox" checked data-column="5">ImageTypeId</label> 
                                                    <label><input type="checkbox" checked data-column="6">SiteId</label> 
                                    ...
                                    <div class="portlet-body">
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                <c:forEach var="site_image" items="${site_imageList}" >
                                                <tr>                                                    
                                                    <td>${site_image.siteImageId}</td> 
                                                    <td>${site_image.fileName}</td> 
                                                    <td>${site_image.description}</td> 
                                                    <td>${site_image.linkUrl}</td> 
                                                    <td>${site_image.rank}</td> 
                                                    <td>${site_image.imageTypeId}</td> 
                                                    <td>${site_image.siteId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${site_image.siteImageId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${site_image.siteImageId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${site_image.siteImageId}").button().click(function() {
                                                        toggleVisibility('itemBox${site_image.siteImageId}');                                                        
                                                        document.getElementById('itemBox${site_image.siteImageId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${site_image.siteImageId}").button().click(function() {
                                                        window.location = '../Operations?form=site_image&action=3&id=${site_image.siteImageId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=site_image&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script>
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    ignore: "",
                    rules: {                                
                        siteImageId:    { required: true, number: true }, 
