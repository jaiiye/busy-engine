...
{
    vendorList = new VendorDaoImpl().findByColumn(request.getParameter("column"), request.getParameter("columnValue"), null, null);
}
else
{
    vendorList = new VendorDaoImpl().findAll(null, null);
}
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "Vendor"); %>
        <%@include file="index_sidebar.jsp"%>
            ...
            <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="VendorUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                            <option value="VendorId" ${param.column == 'VendorId' ? "selected" : "" } >VendorId</option>                                                            
                                                           <option value="VendorName" ${param.column == 'VendorName' ? "selected" : "" } >VendorName</option>                                                            
                                                           ...
                                                           <option value="VendorStatus" ${param.column == 'VendorStatus' ? "selected" : "" } >VendorStatus</option>                                                            
                                                           ...
                                                           <option value="VendorTypeId" ${param.column == 'VendorTypeId' ? "selected" : "" } >VendorTypeId</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'VendorUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <div class="row" id="itemBox${vendor.vendorId}" style="display:${param.id == null ? "none" : vendor.vendorId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${vendor.vendorId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=vendor&action=2" method="post">

                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="vendorId">Vendor:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="vendorId" class="form-control" value="${vendor.vendorId}" />

                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="vendorName">VendorName:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="vendorName" class="form-control maxlength-handler" maxlength="100" value="${vendor.vendorName}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <textarea name="description" class="ckeditor form-control" rows="4">${vendor.description}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="rank" class="form-control" value="${vendor.rank}" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="vendorStatus">VendorStatus:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="vendorStatus" class="form-control" value="${vendor.vendorStatus}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="metaTagId" class="form-control" value="${vendor.metaTagId}" />
                                                        <select name="metaTagId" class="form-control">
                                                            <%Vendor x = (Vendor) pageContext.getAttribute("vendor"); %>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <input type="text" name="templateId" class="form-control" value="${vendor.templateId}" />
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="vendorTypeId">VendorType:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="vendorTypeId" class="form-control" value="${vendor.vendorTypeId}" />
                                                        <select name="vendorTypeId" class="form-control">
                                                            <%Vendor x = (Vendor) pageContext.getAttribute("vendor"); %>
                                                            <%= Database.generateSelectOptionsFromTableAndColumn("vendor_type", x.getVendorTypeId().toString(), 2)%>
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <!-- BEGIN MODAL NEW Vendor FORM-->                    
                        <div id="myModal_new_record" class="modal fade" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                        <h4 class="modal-title">Add a new Vendor</h4>
                                    </div>
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=vendor&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">VendorName</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="vendorName" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="100" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">VendorStatus</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="vendorStatus" class="form-control" placeholder="Enter Integer" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">VendorTypeId</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <select name="vendorTypeId" class="form-control">
                                                                    <%= Database.generateSelectOptionsFromTableAndColumn("vendor_type", "", 2)%>
                                                               </select>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>Vendor Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                            ...
                                            <div class="btn-group"> 
                                                ...
                                                <div id="sample_2_column_toggler" class="dropdown-menu hold-on-click dropdown-checkboxes pull-right">                                                    
                                                    ...
                                                    <label><input type="checkbox" checked data-column="5">MetaTagId</label> 
                                                    <label><input type="checkbox" checked data-column="6">TemplateId</label> 
                                                    <label><input type="checkbox" checked data-column="7">TypeId</label> 
                                    	...
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td>${vendor.metaTagId}</td> 
                                                    <td>${vendor.templateId}</td> 
                                                    <td>${vendor.vendorTypeId}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${vendor.vendorId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${vendor.vendorId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${vendor.vendorId}").button().click(function() {
                                                        toggleVisibility('itemBox${vendor.vendorId}');                                                        
                                                        document.getElementById('itemBox${vendor.vendorId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${vendor.vendorId}").button().click(function() {
                                                        window.location = '../Operations?form=vendor&action=3&id=${vendor.vendorId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=vendor&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
