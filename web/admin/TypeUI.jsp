...
{
    typeList = Type.getAllTypeByColumn(request.getParameter("column"), request.getParameter("columnValue"));
}
else
{
    typeList = Type.getAllType();
}
...
<!DOCTYPE html>
    ...
    <body class="page-header-fixed page-footer-fixed">
        ...
        <% request.setAttribute("subCategory", "Type"); %>
        <%@include file="index_sidebar.jsp"%>
            ...
            <div class="page-content-wrapper">
                    ...
                    <div class="page-content">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="portlet box blue-madison">
                                    ...
                                    <div class="portlet-body">		                                    										
                                        <form method="post" action="TypeUI.jsp" class="form-horizontal" role="form">
                                        	<div class="form-body">
                                                <div class="form-group">
                                                    <div class="col-md-4">
                                                        <select name="column" class="form-control">
                                                           ...
                                                           <option value="TypeRedirectURL" ${param.column == 'TypeRedirectURL' ? "selected" : "" } >TypeRedirectURL</option>                                                            
	                                                ...
	                                                <button type="submit" class="btn grey-silver">Filter</button>
                                                        <button type="button" class="btn grey-cascade" style="float:right" onclick="javascript:window.location = 'TypeUI.jsp';"><i class="fa fa-refresh"></i></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>           
                        ...
                        <div class="row" id="itemBox${type.typeId}" style="display:${param.id == null ? "none" : type.typeId==param.id ? "block" : "none"}">                      
                            <div class="col-md-12">
                                <div class="portlet box green-seagreen">
                                    <div class="portlet-title">
                                        ...
                                        <div class="actions">                                                 
                                            <div class="btn-group">                                
                                                <a href="javascript:toggleVisibility('itemBox${type.typeId}');" class="btn btn-default"><i class="fa fa-times"></i>&nbsp;Close</a> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="portlet-body">	
                                        <div class="portlet-body form">
                                            <form class="form-horizontal" name="edit" action="../Operations?form=type&action=2" method="post">
                                                
                                                <input type="text" name="typeId" value="${type.typeId}" />
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="typeName">TypeName:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="typeName" class="form-control maxlength-handler" maxlength="45" value="${type.typeName}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div  class="col-md-10">
                                                        <textarea name="typeDescription" class="ckeditor form-control" rows="4">${type.typeDescription}</textarea>
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-md-2 control-label" for="typeRedirectURL">TypeRedirectURL:</label>
                                                    <div  class="col-md-10">
                                                        <input type="text" name="typeRedirectURL" class="form-control maxlength-handler" maxlength="255" value="${type.typeRedirectURL}" />
                                                    </div>
                                                </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body form">
                                        <!-- BEGIN FORM-->
                                        <form method="post" action="../Operations?form=type&action=1" id="create_form" class="horizontal-form">
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <textarea name="typeDescription" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="65535" rows="3"></textarea>                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <label class="col-md-2 control-label">TypeRedirectURL</label>
                                                        <div class="col-md-10" style="margin-bottom:25px;">
                                                            <div class="input-icon right">
                                                                <i class="fa"></i>
                                                                <input type="text" name="typeRedirectURL" class="form-control maxlength-handler" placeholder="Enter Text" maxlength="255" />                                                            
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                 <div class="portlet box red-flamingo">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-list-alt"></i>Type Listing
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">                                
                                    	...
                                    	<table class="table table-striped table-bordered table-hover table-full-width" id="sample_2">
                                            ...
                                            <tbody>                                                
                                                ...
                                                <tr>                                                    
                                                    ...
                                                    <td>${type.typeRedirectURL}</td> 
                                                    
                                                    <td>
                                                        <button id="edit-item${type.typeId}" class="btn btn-sm green filter-submit margin-bottom"><span class="glyphicon glyphicon-pencil"></span></button>&nbsp;
                                                        <button id="delete-item${type.typeId}" class="btn btn-sm red filter-cancel"><span class="glyphicon glyphicon-trash"></span></button> 
                                                    </td>
                                                </tr>  
                                                <script type="text/javascript">
                                                    $("#edit-item${type.typeId}").button().click(function() {
                                                        toggleVisibility('itemBox${type.typeId}');                                                        
                                                        document.getElementById('itemBox${type.typeId}').scrollIntoView();
                                                        window.scrollBy(0,-80);
                                                    });
                                                    $("#delete-item${type.typeId}").button().click(function() {
                                                        window.location = '../Operations?form=type&action=3&id=${type.typeId}';
                                                    });
                                                </script>
                                                </c:forEach>
                                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onClick="window.location ='../Operations?form=type&action=4';" type="button" data-dismiss="modal" class="btn green">Yes</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            jQuery(document).ready(function() {
                ...
                form2.validate({
                    ...
                    rules: {                                
                        ...
                        typeDescription:    { required: true, minlength: 1, maxlength: 65535}, 
                        typeRedirectURL:    { required: true, minlength: 1, maxlength: 255} 
