...
import com.transitionsoft.dao.ShippingAddress;
import com.transitionsoft.dao.ShoppingCart;
import com.transitionsoft.dao.Item;
import com.transitionsoft.dao.BillingAddress;
import java.util.*;
...
//                            "&CURRENCYCODE=" + gv_currencyCode;
            ...
            for (int i = 0; i < numItems; i++)
            {
                ...
                nvpstr +=   "&L_PAYMENTREQUEST_0_NAME" + i + "=" + item.getItemName() + 
                            "&L_PAYMENTREQUEST_0_DESC" + i + "=Option:" + item.getItemOption() + 
                            "&L_PAYMENTREQUEST_0_AMT" + i + "=" + item.getItemPrice() + 
                            "&L_PAYMENTREQUEST_0_QTY" + i + "=" + item.getItemQuantity() ;
            }
    ...
    *********************************************************************************/
    ...
    public ShippingAddress getShippingAddress(HashMap shipping_nvp)
    {
        ShippingAddress shipping = new ShippingAddress();

        shipping.setFirstName(shipping_nvp.get("FIRSTNAME").toString());
        shipping.setLastName(shipping_nvp.get("LASTNAME").toString());
        ...
        shipping.setState(shipping_nvp.get("SHIPTOSTATE").toString());
        shipping.setPostalCode(shipping_nvp.get("SHIPTOZIP").toString());
    ...
    *********************************************************************************/
    ...
    {
        ShoppingCart cart = (ShoppingCart) session.getAttribute("ShoppingCart");
        BillingAddress b = cart.getBillingAddress();
