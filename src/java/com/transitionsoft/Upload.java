...
public class Upload 
{
    public static String UploadActivity(MultipartParser parserFormData, String associationType, String fileType, String filePath)
    {    
                        ...
                        if(p.getName().toLowerCase().contains("file"))
                        {
                            ...
                            {                                
                                ...
                                if(associationType.equals("site") && fileType.equals("image")){                                    
                                    Database.addSiteImage("1", fileName, "none");
                                }
                                ...
                                if(associationType.equals("site") && fileType.equals("file")){                                    
                                    Database.addSiteFile(id , fileName, "none");
                                }
                            }                    
                        }
                    }
