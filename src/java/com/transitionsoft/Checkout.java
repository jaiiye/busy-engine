...
public class Checkout extends HttpServlet 
{
    ...
    throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            shipping.setFirstName(request.getParameter("ship_fname"));
            shipping.setLastName(request.getParameter("ship_lname"));        
            ...
            shipping.setState(request.getParameter("ship_state"));
            shipping.setPostalCode(request.getParameter("ship_postalCode"));
            ...
            billing.setFirstName(request.getParameter("bill_fname"));
            billing.setLastName(request.getParameter("bill_lname"));        
            ...
            billing.setState(request.getParameter("bill_state"));
            billing.setPostalCode(request.getParameter("bill_postalCode"));
