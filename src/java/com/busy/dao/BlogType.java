    ...
    public class BlogType extends BasicConnection implements Serializable
    {    
        private static final long serialVersionUID = 1L;        
        public static final String PROP_BLOGTYPEID = "BlogTypeId";
        public static final String PROP_BLOGTYPENAME = "BlogTypeName";
       ...
       this.blogTypeName = ""; 
        ...
        public BlogType(Integer BlogTypeId, String BlogTypeName)
        {
       ...
       this.blogTypeName = BlogTypeName;
        ...
        {            
            if(column.equals(BlogType.PROP_BLOGTYPEID) || column.equals(BlogType.PROP_BLOGTYPENAME) )
            {
                return column;
            }
            else
        ...
        {
            if (column.equals(BlogType.PROP_BLOGTYPEID) )
            {
                return true;
            }        
            else
        ...
        public static int addBlogType(String BlogTypeName)
        {   
            int id = 0;
            try
            {
                
                checkColumnSize(BlogTypeName, 100);
                                            
                openConnection();
                prepareStatement("INSERT INTO blog_type(BlogTypeName) VALUES (?);");                    
                preparedStatement.setString(1, BlogTypeName);
        ...
        public static void updateBlogType(Integer BlogTypeId,String BlogTypeName)
        {  
            try
            {   
                ...
                openConnection();                           
                prepareStatement("UPDATE blog_type SET BlogTypeName=? WHERE BlogTypeId=?;");                    
                preparedStatement.setString(1, BlogTypeName);
