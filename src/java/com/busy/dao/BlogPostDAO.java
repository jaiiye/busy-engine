    ...
    {    
        ...
        public static int addBlogPost(String Title, String Content, String ImageURL, String Tags, Integer Featured, Integer RatingSum, Integer VoteCount, Integer CommentCount, Integer PostStatus, String Excerpt, Date LastModified, String Locale, Integer UserId, Integer BlogId, Integer MetaTagId)
        {   
            int id = 0;
            try
            {
        ...
        public static ArrayList<BlogPost> getAllBlogPostWithRelatedInfo()
        {
            ...
            try
            {
                ...
                while (rs.next())
                {
                    blog_postList.add(processBlogPost(rs));
                }
                    ...
                    for(BlogPost blog_post : blog_postList)
                    {
                            ...
                            blog_post.setUser(UserDAO.processUser(rs));               
                        
                            getRecordById("Blog", blog_post.getBlogId().toString());
                            blog_post.setBlog(BlogDAO.processBlog(rs));               
                        
                            getRecordById("MetaTag", blog_post.getMetaTagId().toString());
                            blog_post.setMetaTag(MetaTagDAO.processMetaTag(rs));               
            ...
            {
                System.out.println("getAllBlogPostWithRelatedInfo error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
        ...
        public static BlogPost getRelatedInfo(BlogPost blog_post)
        {
        ...
        public static BlogPost getAllRelatedObjects(BlogPost blog_post)
        {           
            blog_post.setBlogPostCategoryList(BlogPostCategoryDAO.getAllBlogPostCategoryByColumn("BlogPostId", blog_post.getBlogPostId().toString()));
blog_post.setCommentList(CommentDAO.getAllCommentByColumn("BlogPostId", blog_post.getBlogPostId().toString()));
        ...
        public static BlogPost getRelatedBlogPostCategoryList(BlogPost blog_post)
        {           
            blog_post.setBlogPostCategoryList(BlogPostCategoryDAO.getAllBlogPostCategoryByColumn("BlogPostId", blog_post.getBlogPostId().toString()));
            return blog_post;
        }        
                    
        public static BlogPost getRelatedCommentList(BlogPost blog_post)
        {           
            blog_post.setCommentList(CommentDAO.getAllCommentByColumn("BlogPostId", blog_post.getBlogPostId().toString()));
            return blog_post;
        }        
        ...
        public static void updateBlogPost(Integer BlogPostId,String Title,String Content,String ImageURL,String Tags,Integer Featured,Integer RatingSum,Integer VoteCount,Integer CommentCount,Integer PostStatus,String Excerpt,Date LastModified,String Locale,Integer UserId,Integer BlogId,Integer MetaTagId)
        {  
            try
            {   
