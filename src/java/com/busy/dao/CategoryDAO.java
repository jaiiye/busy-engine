...
public class CategoryDAO extends BasicConnection implements Serializable
{
    ...
    public static int addCategory(String CategoryName, Integer DiscountId, Integer ParentId)
    {
        int id = 0;
        try
        {
    ...
    public static ArrayList<Category> getAllCategoryWithRelatedInfo()
    {
        ...
        try
        {
            ...
            while (rs.next())
            {
                categoryList.add(processCategory(rs));
            }
            ...
            for (Category category : categoryList)
            {
                ...
                category.setDiscount(DiscountDAO.processDiscount(rs));

                getRecordById("Category", category.getParentId().toString());
                category.setParent(CategoryDAO.processCategory(rs));
        ...
        {
            System.out.println("getAllCategoryWithRelatedInfo error: " + ex.getMessage());
        }
        finally
        {
            closeConnection();
    ...
    public static Category getRelatedInfo(Category category)
    {
    ...
    public static Category getAllRelatedObjects(Category category)
    {
        category.setItemCategoryList(ItemCategoryDAO.getAllItemCategoryByColumn("CategoryId", category.getCategoryId().toString()));
        return category;
    }

    public static Category getRelatedItemCategoryList(Category category)
    {
        category.setItemCategoryList(ItemCategoryDAO.getAllItemCategoryByColumn("CategoryId", category.getCategoryId().toString()));
        return category;
    }
    ...
    public static void updateCategory(Integer CategoryId, String CategoryName, Integer DiscountId, Integer ParentId)
    {
        try
        {
