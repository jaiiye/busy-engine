    ...
    public class Locale extends BasicConnection implements Serializable
    {    
        private static final long serialVersionUID = 1L;        
        public static final String PROP_LOCALEID = "LocaleId";
        public static final String PROP_LOCALESTRING = "LocaleString";
        public static final String PROP_LOCALECHARACTERSET = "LocaleCharacterSet";
       ...
       this.localeCharacterSet = LocaleCharacterSet;
        ...
        {            
            if(column.equals(Locale.PROP_LOCALEID) || column.equals(Locale.PROP_LOCALESTRING) || column.equals(Locale.PROP_LOCALECHARACTERSET) )
            {
                return column;
            }
            else
        ...
        {
            if (column.equals(Locale.PROP_LOCALEID) )
            {
                return true;
            }        
            else
