    ...
    {    
        ...
        {            
            if(column.equals(Vendor.PROP_VENDOR_ID) || column.equals(Vendor.PROP_VENDOR_NAME) || column.equals(Vendor.PROP_DESCRIPTION) || column.equals(Vendor.PROP_RANK) || column.equals(Vendor.PROP_STATUS) || column.equals(Vendor.PROP_META_TAG_ID) || column.equals(Vendor.PROP_TEMPLATE_ID) || column.equals(Vendor.PROP_VENDOR_TYPE_ID) )
            {
                return column;
            }
            else
        ...
        {
            if (column.equals(Vendor.PROP_VENDOR_ID) || column.equals(Vendor.PROP_RANK) || column.equals(Vendor.PROP_STATUS) || column.equals(Vendor.PROP_META_TAG_ID) || column.equals(Vendor.PROP_TEMPLATE_ID) || column.equals(Vendor.PROP_VENDOR_TYPE_ID) )
            {
                return true;
            }        
            else
        ...
        public static int addVendor(String VendorName, String Description, Integer Rank, Integer Status, Integer MetaTagId, Integer TemplateId, Integer VendorTypeId)
        {   
            int id = 0;
            try
            {
                ...
                openConnection();
                prepareStatement("INSERT INTO vendor(VendorName,Description,Rank,Status,MetaTagId,TemplateId,VendorTypeId) VALUES (?,?,?,?,?,?,?);");                    
        ...
        public static void updateVendor(Integer VendorId,String VendorName,String Description,Integer Rank,Integer Status,Integer MetaTagId,Integer TemplateId,Integer VendorTypeId)
        {  
            try
            {   
                ...
                openConnection();                           
                prepareStatement("UPDATE vendor SET VendorName=?,Description=?,Rank=?,Status=?,MetaTagId=?,TemplateId=?,VendorTypeId=? WHERE VendorId=?;");                    
                preparedStatement.setString(1, VendorName);
                preparedStatement.setString(2, Description);
                preparedStatement.setInt(3, Rank);
                preparedStatement.setInt(4, Status);
