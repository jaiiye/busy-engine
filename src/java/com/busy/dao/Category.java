    ...
    public class Category extends BasicConnection implements Serializable
    {    
       ...
       this.categoryName = CategoryName;
        ...
        {            
            if(column.equals(Category.PROP_CATEGORYID) || column.equals(Category.PROP_CATEGORYNAME) )
            {
                return column;
            }
            else
        ...
        {
            if (column.equals(Category.PROP_CATEGORYID) )
            {
                return true;
            }        
            else
        ...
        {   
            ...
            try
            {
                ...
                checkColumnSize(CategoryName, 45);
        ...
        public static void updateCategory(Integer CategoryId,String CategoryName)
        {  
            try
            {   
