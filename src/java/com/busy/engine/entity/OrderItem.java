    ...
    {    
       ...
       public Integer getId()
       {
        ...
        {
        builder.add("orderItemId", orderItemId).add("customerOrderId", customerOrderId).add("itemId", itemId).add("quantity", quantity).add("optionName", optionName).add("unitPrice", unitPrice);
        }
