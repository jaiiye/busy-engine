    ...
    {    
       ...
       public Integer getId()
       {
        ...
        public void addJson(JsonObjectBuilder builder)
        {
            ...
            builder.add("discountName", discountName == null ? "" : discountName);
                
            builder.add("discountAmount", discountAmount == null ? 0 : discountAmount);
                
            builder.add("discountPercent", discountPercent == null ? 0 : discountPercent);
            ...
            builder.add("couponCode", couponCode == null ? "" : couponCode);
                
            builder.add("discountStatus", discountStatus == null ? 0 : discountStatus);
                
            builder.add("askCouponCode", askCouponCode == null ? 0 : askCouponCode);
                
            builder.add("usePercentage", usePercentage == null ? 0 : usePercentage);
