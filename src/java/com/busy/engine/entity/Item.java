    ...
    {    
       ...
       public Integer getId()
       {
        ...
        {
        builder.add("itemId", itemId).add("itemName", itemName).add("description", description).add("listPrice", listPrice).add("price", price).add("shortDescription", shortDescription).add("adjustment", adjustment).add("sku", sku).add("ratingSum", ratingSum).add("voteCount", voteCount).add("rank", rank).add("itemStatus", itemStatus).add("locale", locale).add("itemTypeId", itemTypeId).add("itemBrandId", itemBrandId).add("metaTagId", metaTagId).add("templateId", templateId).add("vendorId", vendorId);
        }
