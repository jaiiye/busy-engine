    ...
    {    
       ...
       public Integer getId()
       {
        ...
        {
        builder.add("userId", userId).add("username", username).add("password", password).add("email", email).add("securityQuestion", securityQuestion).add("securityAnswer", securityAnswer).add("registerDate", new SimpleDateFormat("yyyyMMdd").format(registerDate)).add("imageURL", imageURL).add("userStatus", userStatus).add("rank", rank).add("webUrl", webUrl).add("itemBrandId", itemBrandId).add("userTypeId", userTypeId).add("addressId", addressId).add("contactId", contactId).add("userGroupId", userGroupId);
        }
       
       public static String checkColumnName(String column) throws SQLException
        {            
            if(column.equals(User.PROP_USER_ID) || column.equals(User.PROP_USERNAME) || column.equals(User.PROP_PASSWORD) || column.equals(User.PROP_EMAIL) || column.equals(User.PROP_SECURITY_QUESTION) || column.equals(User.PROP_SECURITY_ANSWER) || column.equals(User.PROP_REGISTER_DATE) || column.equals(User.PROP_IMAGE_U_R_L) || column.equals(User.PROP_USER_STATUS) || column.equals(User.PROP_RANK) || column.equals(User.PROP_WEB_URL) || column.equals(User.PROP_ITEM_BRAND_ID) || column.equals(User.PROP_USER_TYPE_ID) || column.equals(User.PROP_ADDRESS_ID) || column.equals(User.PROP_CONTACT_ID) || column.equals(User.PROP_USER_GROUP_ID) )
            {
                return column;
            }
            else
