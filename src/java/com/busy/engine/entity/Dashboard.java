...
public class Dashboard extends AbstractEntity implements EntityItem<Integer>
{
    ...
    public static final String PROP_FILE_COUNT = "FileCount";
    public static final String PROP_FOLDER_COUNT = "FolderCount";
    public static final String PROP_EMAIL_COUNT = "EmailCount";
    ...
    public static Dashboard process(ResultSet rs) throws SQLException
    {
        ...
        return new Dashboard(rs.getInt(1), rs.getInt(2), rs.getInt(3), rs.getInt(4), rs.getInt(5), rs.getInt(6), rs.getInt(7), rs.getInt(8), rs.getInt(9), rs.getInt(10), rs.getInt(11), rs.getInt(12), rs.getInt(13), rs.getInt(14), rs.getInt(15), rs.getInt(16), rs.getInt(17), rs.getInt(18));
    }
