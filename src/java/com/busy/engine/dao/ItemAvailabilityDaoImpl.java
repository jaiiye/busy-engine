    ...
    {    
        ...
        @Override
        public ArrayList<ItemAvailability> findByColumns(Column... columns)
        {
            ArrayList<ItemAvailability> itemAvailabilityList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(ItemAvailability.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("item_availability", columns);
                while (rs.next())
                {
                    itemAvailabilityList.add(ItemAvailability.process(rs));
                }
            ...
            {
                System.out.println("ItemAvailability's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
