    ...
    {    
        ...
        {        
            ...
            {                
                ...
                openConnection();
                prepareStatement("INSERT INTO address(AddressId,Recipient,Address1,Address2,City,StateProvince,ZipPostalCode,Country,Region,AddressStatus,Locale,) VALUES (?,?,?,?,?,?,?,?,?,?);");                    
