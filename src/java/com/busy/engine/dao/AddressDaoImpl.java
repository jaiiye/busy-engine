    ...
    {    
        ...
        @Override
        public ArrayList<Address> findByColumns(Column... columns)
        {
            ArrayList<Address> addressList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(Address.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("address", columns);
                while (rs.next())
                {
                    addressList.add(Address.process(rs));
                }
            ...
            {
                System.out.println("Address's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
