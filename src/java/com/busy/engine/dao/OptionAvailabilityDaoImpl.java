...
public class OptionAvailabilityDaoImpl extends BasicConnection implements Serializable, OptionAvailabilityDao
{
    ...
    public OptionAvailability update(OptionAvailability obj)
    {
        try
        {
            ...
            openConnection();
            prepareStatement("UPDATE option_availability SET com.busy.util.DatabaseColumn@7b5b83df=?,com.busy.util.DatabaseColumn@42bc7156=?,com.busy.util.DatabaseColumn@2b1991c3=?,com.busy.util.DatabaseColumn@614dff25=?,com.busy.util.DatabaseColumn@46afcda8=?,com.busy.util.DatabaseColumn@673822ea=?,com.busy.util.DatabaseColumn@c83047=?,com.busy.util.DatabaseColumn@e7253ac=? WHERE OptionAvailabilityId=?;");
            preparedStatement.setInt(0, obj.getOptionAvailabilityId());
            preparedStatement.setInt(1, obj.getItemId());
            preparedStatement.setInt(2, obj.getItemOptionId());
            preparedStatement.setInt(3, obj.getItemAvailabilityId());
