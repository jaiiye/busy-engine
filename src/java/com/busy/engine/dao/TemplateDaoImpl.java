...
public class TemplateDaoImpl extends BasicConnection implements Serializable, TemplateDao
{
    ...
    @Override
    public Template findWithInfo(Integer id)
    {
        Template template = findByColumn("TemplateId", id.toString(), null, null).get(0);
        ...
        {
            System.out.println("Object Template method findWithInfo(Integer id) error: " + ex.getMessage());
        }
        finally
        {
            closeConnection();
    ...
    public void getRelatedTemplateType(Template template)
    {
        try
        {
        ...
        {
            System.out.println("getTemplateType error: " + ex.getMessage());
        }
        finally
        {
            closeConnection();
    ...
    public void getRelatedParentTemplate(Template template)
    {
        try
        {
            getRecordById("Template", template.getParentTemplateId().toString());
        ...
        {
            System.out.println("getParentTemplate error: " + ex.getMessage());
        }
        finally
        {
            closeConnection();
    ...
    public void getRelatedTemplateTypeWithInfo(Template template)
    {
        template.setTemplateType(new TemplateTypeDaoImpl().findWithInfo(template.getTemplateTypeId()));
    }

    public void getRelatedParentTemplateWithInfo(Template template)
    {
        template.setParentTemplate(new TemplateDaoImpl().findWithInfo(template.getParentTemplateId()));
    }
