    ...
    {    
        ...
        @Override
        public ArrayList<TextString> findByColumns(Column... columns)
        {
            ArrayList<TextString> textStringList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(TextString.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("text_string", columns);
                while (rs.next())
                {
                    textStringList.add(TextString.process(rs));
                }
            ...
            {
                System.out.println("TextString's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
