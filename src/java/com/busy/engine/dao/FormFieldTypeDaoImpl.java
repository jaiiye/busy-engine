    ...
    {    
        ...
        @Override
        public ArrayList<FormFieldType> findByColumns(Column... columns)
        {
            ArrayList<FormFieldType> formFieldTypeList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(FormFieldType.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("form_field_type", columns);
                while (rs.next())
                {
                    formFieldTypeList.add(FormFieldType.process(rs));
                }
            ...
            {
                System.out.println("FormFieldType's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
