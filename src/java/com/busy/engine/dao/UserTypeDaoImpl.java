    ...
    {    
        ...
        @Override
        public ArrayList<UserType> findByColumns(Column... columns)
        {
            ArrayList<UserType> userTypeList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(UserType.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("user_type", columns);
                while (rs.next())
                {
                    userTypeList.add(UserType.process(rs));
                }
            ...
            {
                System.out.println("UserType's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
