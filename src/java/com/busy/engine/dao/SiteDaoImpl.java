...
public class SiteDaoImpl extends BasicConnection implements Serializable, SiteDao
{
    ...
    public Site findWithInfo(Integer id)
    {
        ...
        try
        {
            ...
            getRecordById("site_email", site.getSiteEmailId().toString());
    ...
    @Override
    public ArrayList<Site> findByColumns(Column... columns)
    {
        ArrayList<Site> siteList = new ArrayList<>();
        ...
        try
        {
            ...
            {
                c.setNumeric(Site.isColumnNumeric(c.getColumnName()));
            }

            getAllRecordsByColumns("site", columns);
            while (rs.next())
            {
                siteList.add(Site.process(rs));
            }
        ...
        {
            System.out.println("Site's method findByColumns(Column... columns) error: " + ex.getMessage());
        }
        finally
        {
            closeConnection();
    ...
    public int add(Site obj)
    {
        ...
        try
        {
            ...
            Site.checkColumnSize(obj.getLocale(), 10);
