    ...
    {    
        ...
        @Override
        public ArrayList<RelatedItem> findByColumns(Column... columns)
        {
            ArrayList<RelatedItem> relatedItemList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(RelatedItem.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("related_item", columns);
                while (rs.next())
                {
                    relatedItemList.add(RelatedItem.process(rs));
                }
            ...
            {
                System.out.println("RelatedItem's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
