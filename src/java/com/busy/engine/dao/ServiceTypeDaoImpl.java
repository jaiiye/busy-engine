    ...
    {    
        ...
        @Override
        public ArrayList<ServiceType> findByColumns(Column... columns)
        {
            ArrayList<ServiceType> serviceTypeList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(ServiceType.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("service_type", columns);
                while (rs.next())
                {
                    serviceTypeList.add(ServiceType.process(rs));
                }
            ...
            {
                System.out.println("ServiceType's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
