    ...
    {    
        ...
        @Override
        public ArrayList<PostCategory> findByColumns(Column... columns)
        {
            ArrayList<PostCategory> postCategoryList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(PostCategory.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("post_category", columns);
                while (rs.next())
                {
                    postCategoryList.add(PostCategory.process(rs));
                }
            ...
            {
                System.out.println("PostCategory's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
