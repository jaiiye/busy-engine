    ...
    {    
        ...
        public SiteImage findWithInfo(Integer id)
        {
            SiteImage siteImage = findByColumn("SiteImageId", id.toString(), null, null).get(0);
                ...
                try
                {
                    ...
                    getRecordById("image_type", siteImage.getImageTypeId().toString());
        ...
        @Override
        public ArrayList<SiteImage> findByColumns(Column... columns)
        {
            ArrayList<SiteImage> siteImageList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(SiteImage.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("site_image", columns);
                while (rs.next())
                {
                    siteImageList.add(SiteImage.process(rs));
                }
            ...
            {
                System.out.println("SiteImage's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
        ...
        public void getRelatedInfo(SiteImage site_image)
        {
                ...
                { 
                            ...
                            getRecordById("image_type", site_image.getImageTypeId().toString());
