    ...
    {    
        ...
        @Override
        public ArrayList<Mailinglist> findByColumns(Column... columns)
        {
            ArrayList<Mailinglist> mailinglistList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(Mailinglist.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("mailinglist", columns);
                while (rs.next())
                {
                    mailinglistList.add(Mailinglist.process(rs));
                }
            ...
            {
                System.out.println("Mailinglist's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
