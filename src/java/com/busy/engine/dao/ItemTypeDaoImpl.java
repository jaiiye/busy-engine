    ...
    {    
        ...
        @Override
        public ArrayList<ItemType> findByColumns(Column... columns)
        {
            ArrayList<ItemType> itemTypeList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(ItemType.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("item_type", columns);
                while (rs.next())
                {
                    itemTypeList.add(ItemType.process(rs));
                }
            ...
            {
                System.out.println("ItemType's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
