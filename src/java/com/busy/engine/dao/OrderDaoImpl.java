        ...
        public Order update(Order obj)
        {
           try
            {   
                ...
                openConnection();                           
                prepareStatement("UPDATE order SET com.busy.util.DatabaseColumn@52bdd0c4=?,com.busy.util.DatabaseColumn@2578fd4f=?,com.busy.util.DatabaseColumn@55c44fae=?,com.busy.util.DatabaseColumn@3952e43d=?,com.busy.util.DatabaseColumn@5d52823=?,com.busy.util.DatabaseColumn@67a52f53=?,com.busy.util.DatabaseColumn@106ba536=?,com.busy.util.DatabaseColumn@3eb6d80a=?,com.busy.util.DatabaseColumn@120e6bcf=?,com.busy.util.DatabaseColumn@5c9f116a=?,com.busy.util.DatabaseColumn@11905dda=?,com.busy.util.DatabaseColumn@19eeb16a=?,com.busy.util.DatabaseColumn@785fe18b=?,com.busy.util.DatabaseColumn@5c6fbbab=?,com.busy.util.DatabaseColumn@4f024371=?,com.busy.util.DatabaseColumn@238bce1a=?,com.busy.util.DatabaseColumn@245f3059=?,com.busy.util.DatabaseColumn@5cc659a=?,com.busy.util.DatabaseColumn@5888b799=?,com.busy.util.DatabaseColumn@258e598c=?,com.busy.util.DatabaseColumn@788e689c=?,com.busy.util.DatabaseColumn@1e0832a2=? WHERE OrderId=?;");                    
                preparedStatement.setInt(0, obj.getOrderId());
                preparedStatement.setDate(1, new java.sql.Date(obj.getOrderDate().getTime()));
                preparedStatement.setDate(2, new java.sql.Date(obj.getShipDate().getTime()));
                preparedStatement.setString(3, obj.getPaymentMethod());
