    ...
    {    
        ...
        @Override
        public ArrayList<Discount> findByColumns(Column... columns)
        {
            ArrayList<Discount> discountList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(Discount.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("discount", columns);
                while (rs.next())
                {
                    discountList.add(Discount.process(rs));
                }
            ...
            {
                System.out.println("Discount's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
