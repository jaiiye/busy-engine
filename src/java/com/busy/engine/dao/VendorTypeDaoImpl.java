    ...
    {    
        ...
        @Override
        public ArrayList<VendorType> findByColumns(Column... columns)
        {
            ArrayList<VendorType> vendorTypeList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(VendorType.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("vendor_type", columns);
                while (rs.next())
                {
                    vendorTypeList.add(VendorType.process(rs));
                }
            ...
            {
                System.out.println("VendorType's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
