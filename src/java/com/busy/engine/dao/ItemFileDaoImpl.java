    ...
    {    
        ...
        @Override
        public ItemFile findWithInfo(Integer id)
        {
            ItemFile itemFile = findByColumn("ItemFileId", id.toString(), null, null).get(0);
                ...
                {
                        System.out.println("Object ItemFile method findWithInfo(Integer id) error: " + ex.getMessage());
                }
                finally
                {
                    closeConnection();
        ...
        public void getRelatedItem(ItemFile item_file)
        {            
            try
            {                 
                getRecordById("Item", item_file.getItemId().toString());
        ...
        public void getRelatedItemWithInfo(ItemFile item_file)
        {            
            item_file.setItem(new ItemDaoImpl().findWithInfo(item_file.getItemId()));
        }
