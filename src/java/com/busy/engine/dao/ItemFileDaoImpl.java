...
public class ItemFileDaoImpl extends BasicConnection implements Serializable, ItemFileDao
{
    ...
    public ItemFile update(ItemFile obj)
    {
        try
        {
            ...
            openConnection();
            prepareStatement("UPDATE item_file SET com.busy.util.DatabaseColumn@6c942f42=?,com.busy.util.DatabaseColumn@257c4fd6=?,com.busy.util.DatabaseColumn@df3f02b=?,com.busy.util.DatabaseColumn@69d64c4c=?,com.busy.util.DatabaseColumn@24f5800b=? WHERE ItemFileId=?;");
            preparedStatement.setInt(0, obj.getItemFileId());
            preparedStatement.setString(1, obj.getFileName());
            preparedStatement.setString(2, obj.getDescription());
            preparedStatement.setString(3, obj.getLabel());
