    ...
    {    
        ...
        @Override
        public ArrayList<ItemOption> findByColumns(Column... columns)
        {
            ArrayList<ItemOption> itemOptionList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(ItemOption.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("item_option", columns);
                while (rs.next())
                {
                    itemOptionList.add(ItemOption.process(rs));
                }
            ...
            {
                System.out.println("ItemOption's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
