    ...
    {    
        ...
        public LocalizedString findWithInfo(Integer id)
        {
            LocalizedString localizedString = findByColumn("LocalizedStringId", id.toString(), null, null).get(0);
                ...
                try
                {
                    ...
                    getRecordById("text_string", localizedString.getTextStringId().toString());
        ...
        @Override
        public ArrayList<LocalizedString> findByColumns(Column... columns)
        {
            ArrayList<LocalizedString> localizedStringList = new ArrayList<>();
            ...
            try
            {
                ...
                {
                    c.setNumeric(LocalizedString.isColumnNumeric(c.getColumnName()));                
                }

                getAllRecordsByColumns("localized_string", columns);
                while (rs.next())
                {
                    localizedStringList.add(LocalizedString.process(rs));
                }
            ...
            {
                System.out.println("LocalizedString's method findByColumns(Column... columns) error: " + ex.getMessage());
            }
            finally
            {
                closeConnection();
        ...
        {        
            ...
            {                
                ...
                LocalizedString.checkColumnSize(obj.getLocale(), 10);
                ...
                preparedStatement.setString(1, obj.getLocale());
        ...
        public void getRelatedInfo(LocalizedString localized_string)
        {
                ...
                { 
                            ...
                            getRecordById("text_string", localized_string.getTextStringId().toString());
