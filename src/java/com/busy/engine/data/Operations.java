...
public class Operations extends HttpServlet
{
    ...
    {
        String userName = (request.getUserPrincipal() == null || request.getUserPrincipal().getName() == null) ? "Guest" : request.getUserPrincipal().getName();
        User u = null;
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    ...
                    case 5:  //testing the Dao
                        itemDaoImpl.setCachingEnabled(true);
                        ArrayList<Item> items = itemDaoImpl.findAll(null, null);
                        itemDaoImpl.find(2);
                        itemDaoImpl.findByColumn(Item.PROP_ITEM_NAME,"Sand", null, null);
                        break;
                    default:
