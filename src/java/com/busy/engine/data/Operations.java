...
public class Operations extends HttpServlet
{
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Address", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Affiliate", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Blog", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "BlogPost", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "BlogPostCategory", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "BlogType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Category", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Comment", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Contact", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Country", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Customer", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "CustomerOrder", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Discount", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "EntityStatus", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "FileFolder", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Form", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "FormField", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "FormFieldType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ImageType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemAttribute", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemAttributeType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemAvailability", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemBrand", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemCategory", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemDiscount", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemFile", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemImage", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemLocation", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemOption", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemReview", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ItemType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "KnowledgeBase", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Mailinglist", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "MetaTag", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "OptionAvailability", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Order", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "OrderItem", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Page", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Paypal", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "PostCategory", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "RecurringPayment", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "RelatedItem", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ResourceType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ResourceUrl", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ReturnRequest", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Service", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ServiceCharge", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "ServiceType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Shipment", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Shipping", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteAttribute", id);
                        }
        ...
        if (request.getParameter("form").equals("site_email"))
        {
            try
            {
                SiteEmailDao siteEmailDao = (SiteEmailDao) this.getServletContext().getAttribute("siteEmailDao");

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        int id = siteEmailDao.add(new SiteEmail(null, request.getParameter("host"), Integer.parseInt(request.getParameter("port")), request.getParameter("username"), request.getParameter("password")));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteEmail", id);
                        }

                        response.sendRedirect("admin/SiteEmailUI.jsp?SuccessMsg=Added SiteEmail Successfully!");
                        break;
                    case 2: //update            
                        siteEmailDao.update(new SiteEmail(Integer.parseInt(request.getParameter("siteEmailId")), request.getParameter("host"), Integer.parseInt(request.getParameter("port")), request.getParameter("username"), request.getParameter("password")));
                        Database.RecordUserObjectUpdateAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteEmail", Integer.parseInt(request.getParameter("siteEmailId")));
                        response.sendRedirect("admin/SiteEmailUI.jsp?id=" + request.getParameter("siteEmailId") + "&SuccessMsg=Updated SiteEmail Successfully!");
                        break;
                    case 3:  //delete
                        siteEmailDao.removeById(Integer.parseInt(request.getParameter("id")));
                        Database.RecordUserObjectDeletionAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteEmail", request.getParameter("id"));

                        response.sendRedirect("admin/SiteEmailUI.jsp?SuccessMsg=Deleted SiteEmail Successfully!");
                        break;
                    case 4:  //remove all records
                        siteEmailDao.removeAll();
                        Database.RecordUserObjectClearAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteEmail");
                        response.sendRedirect("admin/SiteEmailUI.jsp?SuccessMsg=Removed All Records Successfully!");
                        break;
                    default:
                        response.sendRedirect("admin/SiteEmailUI.jsp?ErrorMsg=Error editing SiteEmail, Invalid Action.");
                        break;
                }
            }
            catch (Exception e)
            {
                ...
                {
                    case 1:
                        response.sendRedirect("admin/SiteEmailUI.jsp?ErrorMsg=Error adding SiteEmail.");
                        break; //create
                    case 2:
                        response.sendRedirect("admin/SiteEmailUI.jsp?ErrorMsg=Error editing SiteEmail.");
                        break; //update                                                    
                    case 3:
                        response.sendRedirect("admin/SiteEmailUI.jsp?ErrorMsg=Error deleting SiteEmail.");
                        break; //delete                                                    
                    case 4:
                        response.sendRedirect("admin/SiteEmailUI.jsp?ErrorMsg=Error clearing SiteEmail.");
                        break; //clear                          
                    default:
                        response.sendRedirect("admin/SiteEmailUI.jsp?ErrorMsg=Unknown Error SiteEmail, possibly an invalid action.");
                        break;
                }
            }
        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteFile", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteFolder", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteImage", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteItem", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SiteLanguage", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SitePage", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Slider", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SliderItem", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "SliderType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "StateProvince", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "TaxRate", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Template", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "TemplateType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "TextString", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "User", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "UserAction", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "UserActionType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "UserGroup", id);
                        }
        ...
        if (request.getParameter("form").equals("user_role"))
        {
            try
            {
                ...
                {
                    case 1: //create                        
                        int id = userRoleDao.add(new UserRole(null, request.getParameter("roleName")));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "UserRole", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "UserService", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "UserType", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "Vendor", id);
                        }
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create                        
                        ...
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(user.getUserId().toString(), user.getUsername(), currentTime, "VendorType", id);
                        }
