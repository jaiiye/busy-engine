...
import com.busy.engine.dao.impl.*;
...
public class Operations extends HttpServlet
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        ...
                        break;
                    case 2: //update            
                        AddressDaoImpl.update(Integer.parseInt(request.getParameter("addressId")), request.getParameter("recipient"), request.getParameter("address1"), request.getParameter("address2"), request.getParameter("city"), request.getParameter("stateProvince"), request.getParameter("zipPostalCode"), request.getParameter("country"), request.getParameter("region"), Integer.parseInt(request.getParameter("addressStatus")), request.getParameter("locale"));
                        ...
                        break;
                    case 3:  //delete
                        addressDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("affiliate"))
        {
            try
            {
                AffiliateDao affiliateDao = new AffiliateDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = AffiliateDaoImpl.add(request.getParameter("companyName"), request.getParameter("email"), request.getParameter("phone"), request.getParameter("fax"), request.getParameter("webUrl"), request.getParameter("details"), Integer.parseInt(request.getParameter("serviceHours")), Integer.parseInt(request.getParameter("affiliateStatus")), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("contactId")), Integer.parseInt(request.getParameter("addressId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        AffiliateDaoImpl.update(Integer.parseInt(request.getParameter("affiliateId")), request.getParameter("companyName"), request.getParameter("email"), request.getParameter("phone"), request.getParameter("fax"), request.getParameter("webUrl"), request.getParameter("details"), Integer.parseInt(request.getParameter("serviceHours")), Integer.parseInt(request.getParameter("affiliateStatus")), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("contactId")), Integer.parseInt(request.getParameter("addressId")));
                        ...
                        break;
                    case 3:  //delete
                        affiliateDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("blog"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = BlogDaoImpl.add(request.getParameter("topic"), Integer.parseInt(request.getParameter("blogTypeId")), Integer.parseInt(request.getParameter("knowledgeBaseId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        BlogDaoImpl.update(Integer.parseInt(request.getParameter("blogId")), request.getParameter("topic"), Integer.parseInt(request.getParameter("blogTypeId")), Integer.parseInt(request.getParameter("knowledgeBaseId")));
                        ...
                        break;
                    case 3:  //delete
                        blogDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("blog_post"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = BlogPostDaoImpl.add(request.getParameter("title"), request.getParameter("content"), request.getParameter("imageURL"), request.getParameter("tags"), Integer.parseInt(request.getParameter("featured")), Integer.parseInt(request.getParameter("ratingSum")), Integer.parseInt(request.getParameter("voteCount")), Integer.parseInt(request.getParameter("commentCount")), Integer.parseInt(request.getParameter("postStatus")), request.getParameter("excerpt"), operatingDateFormat.parse(request.getParameter("lastModified")), request.getParameter("locale"), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("blogId")), Integer.parseInt(request.getParameter("metaTagId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        BlogPostDaoImpl.update(Integer.parseInt(request.getParameter("blogPostId")), request.getParameter("title"), request.getParameter("content"), request.getParameter("imageURL"), request.getParameter("tags"), Integer.parseInt(request.getParameter("featured")), Integer.parseInt(request.getParameter("ratingSum")), Integer.parseInt(request.getParameter("voteCount")), Integer.parseInt(request.getParameter("commentCount")), Integer.parseInt(request.getParameter("postStatus")), request.getParameter("excerpt"), operatingDateFormat.parse(request.getParameter("lastModified")), request.getParameter("locale"), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("blogId")), Integer.parseInt(request.getParameter("metaTagId")));
                        ...
                        break;
                    case 3:  //delete
                        blogPostDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("blog_post_category"))
        {
            try
            {
                BlogPostCategoryDao blogPostCategoryDao = new BlogPostCategoryDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = BlogPostCategoryDaoImpl.add(Integer.parseInt(request.getParameter("blogPostId")), Integer.parseInt(request.getParameter("postCategoryId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        BlogPostCategoryDaoImpl.update(Integer.parseInt(request.getParameter("blogPostCategoryId")), Integer.parseInt(request.getParameter("blogPostId")), Integer.parseInt(request.getParameter("postCategoryId")));
                        ...
                        break;
                    case 3:  //delete
                        blogPostCategoryDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("blog_type"))
        {
            try
            {
                BlogTypeDao blogTypeDao = new BlogTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = BlogTypeDaoImpl.add(request.getParameter("typeName"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        BlogTypeDaoImpl.update(Integer.parseInt(request.getParameter("blogTypeId")), request.getParameter("typeName"));
                        ...
                        break;
                    case 3:  //delete
                        blogTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("category"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = CategoryDaoImpl.add(request.getParameter("categoryName"), Integer.parseInt(request.getParameter("discountId")), Integer.parseInt(request.getParameter("parentId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        CategoryDaoImpl.update(Integer.parseInt(request.getParameter("categoryId")), request.getParameter("categoryName"), Integer.parseInt(request.getParameter("discountId")), Integer.parseInt(request.getParameter("parentId")));
                        ...
                        break;
                    case 3:  //delete
                        categoryDao.remove(Integer.parseInt(request.getParameter("id")));
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        ...
                        break;
                    case 2: //update            
                        CommentDaoImpl.update(Integer.parseInt(request.getParameter("commentId")), request.getParameter("title"), request.getParameter("content"), operatingDateFormat.parse(request.getParameter("date")), Integer.parseInt(request.getParameter("commentStatus")), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("blogPostId")), Integer.parseInt(request.getParameter("itemReviewId")));
                        ...
                        break;
                    case 3:  //delete
                        commentDao.remove(Integer.parseInt(request.getParameter("id")));
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    ...
                    case 2: //update            
                        ...
                        break;
                    case 3:  //delete
                        contactDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("country"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = CountryDaoImpl.add(request.getParameter("name"), request.getParameter("isoCode"), Integer.parseInt(request.getParameter("isoNumber")), Integer.parseInt(request.getParameter("hasVat")));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(u.getUserId().toString(), u.getUserName(), currentTime, "Country", id);
                        }

                        response.sendRedirect("admin/CountryUI.jsp?SuccessMsg=Added Country Successfully!");
                        break;
                    case 2: //update            
                        CountryDaoImpl.update(Integer.parseInt(request.getParameter("countryId")), request.getParameter("name"), request.getParameter("isoCode"), Integer.parseInt(request.getParameter("isoNumber")), Integer.parseInt(request.getParameter("hasVat")));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "Country", Integer.parseInt(request.getParameter("countryId")));
                        response.sendRedirect("admin/CountryUI.jsp?id=" + request.getParameter("countryId") + "&SuccessMsg=Updated Country Successfully!");
                        break;
                    case 3:  //delete
                        countryDao.remove(Integer.parseInt(request.getParameter("id")));
                        Database.RecordUserObjectDeletionAction(u.getUserId().toString(), u.getUserName(), currentTime, "Country", request.getParameter("id"));

                        response.sendRedirect("admin/CountryUI.jsp?SuccessMsg=Deleted Country Successfully!");
                        break;
                    case 4:  //remove all records
                        countryDao.removeAll();
                        Database.RecordUserObjectClearAction(u.getUserId().toString(), u.getUserName(), currentTime, "Country");
                        response.sendRedirect("admin/CountryUI.jsp?SuccessMsg=Removed All Records Successfully!");
                        break;
                    default:
                        response.sendRedirect("admin/CountryUI.jsp?ErrorMsg=Error editing Country, Invalid Action.");
                        break;
                }
            }
            catch (Exception e)
            {
                ...
                {
                    case 1:
                        response.sendRedirect("admin/CountryUI.jsp?ErrorMsg=Error adding Country.");
                        break; //create
                    case 2:
                        response.sendRedirect("admin/CountryUI.jsp?ErrorMsg=Error editing Country.");
                        break; //update                                                    
                    case 3:
                        response.sendRedirect("admin/CountryUI.jsp?ErrorMsg=Error deleting Country.");
                        break; //delete                                                    
                    case 4:
                        response.sendRedirect("admin/CountryUI.jsp?ErrorMsg=Error clearing Country.");
                        break; //clear                          
                    default:
                        response.sendRedirect("admin/CountryUI.jsp?ErrorMsg=Unknown Error Country, possibly an invalid action.");
                        break;
                }
            }
        }
        ...
        if (request.getParameter("form").equals("customer"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = CustomerDaoImpl.add(Integer.parseInt(request.getParameter("contactId")), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("billingAddressId")), Integer.parseInt(request.getParameter("shippingAddressId")), Integer.parseInt(request.getParameter("customerStatus")));
                        if (id != 0)
                        {
        ...
        if (request.getParameter("form").equals("customer_order"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = CustomerOrderDaoImpl.add(Integer.parseInt(request.getParameter("customerId")), Integer.parseInt(request.getParameter("orderId")), Integer.parseInt(request.getParameter("discountId")), request.getParameter("customerIp"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        CustomerOrderDaoImpl.update(Integer.parseInt(request.getParameter("customerOrderId")), Integer.parseInt(request.getParameter("customerId")), Integer.parseInt(request.getParameter("orderId")), Integer.parseInt(request.getParameter("discountId")), request.getParameter("customerIp"));
                        ...
                        break;
                    case 3:  //delete
                        customerOrderDao.remove(Integer.parseInt(request.getParameter("id")));
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        ...
                        break;
                    case 2: //update            
                        DashboardDaoImpl.update(Integer.parseInt(request.getParameter("dashboardId")), Integer.parseInt(request.getParameter("userCount")), Integer.parseInt(request.getParameter("blogPostCount")), Integer.parseInt(request.getParameter("itemCount")), Integer.parseInt(request.getParameter("orderCount")), Integer.parseInt(request.getParameter("siteFileCount")), Integer.parseInt(request.getParameter("imageCount")), Integer.parseInt(request.getParameter("blogCount")), Integer.parseInt(request.getParameter("commentCount")), Integer.parseInt(request.getParameter("pageCount")), Integer.parseInt(request.getParameter("formCount")), Integer.parseInt(request.getParameter("sliderCount")), Integer.parseInt(request.getParameter("itemBrandCount")), Integer.parseInt(request.getParameter("categoryCount")), Integer.parseInt(request.getParameter("itemOptionCount")));
                        ...
                        break;
                    case 3:  //delete
                        dashboardDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("discount"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = DiscountDaoImpl.add(request.getParameter("discountName"), Double.parseDouble(request.getParameter("discountAmount")), Double.parseDouble(request.getParameter("discountPercent")), operatingDateFormat.parse(request.getParameter("startDate")), operatingDateFormat.parse(request.getParameter("endDate")), request.getParameter("couponCode"), Integer.parseInt(request.getParameter("discountStatus")), Integer.parseInt(request.getParameter("askCouponCode")), Integer.parseInt(request.getParameter("usePercentage")));
                        if (id != 0)
                        {
                    ...
                    case 2: //update            
                        ...
                        break;
                    case 3:  //delete
                        discountDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("entity_status"))
        {
            try
            {
                EntityStatusDao entityStatusDao = new EntityStatusDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = EntityStatusDaoImpl.add(Integer.parseInt(request.getParameter("statusCode")), request.getParameter("statusName"), request.getParameter("appliesTo"));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(u.getUserId().toString(), u.getUserName(), currentTime, "EntityStatus", id);
                        }

                        response.sendRedirect("admin/EntityStatusUI.jsp?SuccessMsg=Added EntityStatus Successfully!");
                        break;
                    case 2: //update            
                        EntityStatusDaoImpl.update(Integer.parseInt(request.getParameter("entityStatusId")), Integer.parseInt(request.getParameter("statusCode")), request.getParameter("statusName"), request.getParameter("appliesTo"));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "EntityStatus", Integer.parseInt(request.getParameter("entityStatusId")));
                        ...
                        break;
                    case 3:  //delete
                        entityStatusDao.remove(Integer.parseInt(request.getParameter("id")));
                        Database.RecordUserObjectDeletionAction(u.getUserId().toString(), u.getUserName(), currentTime, "EntityStatus", request.getParameter("id"));

                        response.sendRedirect("admin/EntityStatusUI.jsp?SuccessMsg=Deleted EntityStatus Successfully!");
                        break;
                    case 4:  //remove all records
                        entityStatusDao.removeAll();
                        Database.RecordUserObjectClearAction(u.getUserId().toString(), u.getUserName(), currentTime, "EntityStatus");
                        response.sendRedirect("admin/EntityStatusUI.jsp?SuccessMsg=Removed All Records Successfully!");
                        break;
                    default:
                        response.sendRedirect("admin/EntityStatusUI.jsp?ErrorMsg=Error editing EntityStatus, Invalid Action.");
                        break;
                }
            }
            catch (Exception e)
            {
                ...
                {
                    case 1:
                        response.sendRedirect("admin/EntityStatusUI.jsp?ErrorMsg=Error adding EntityStatus.");
                        break; //create
                    case 2:
                        response.sendRedirect("admin/EntityStatusUI.jsp?ErrorMsg=Error editing EntityStatus.");
                        break; //update                                                    
                    case 3:
                        response.sendRedirect("admin/EntityStatusUI.jsp?ErrorMsg=Error deleting EntityStatus.");
                        break; //delete                                                    
                    case 4:
                        response.sendRedirect("admin/EntityStatusUI.jsp?ErrorMsg=Error clearing EntityStatus.");
                        break; //clear                          
                    default:
                        response.sendRedirect("admin/EntityStatusUI.jsp?ErrorMsg=Unknown Error EntityStatus, possibly an invalid action.");
                        break;
                }
            }
        }
        ...
        if (request.getParameter("form").equals("file_folder"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = FileFolderDaoImpl.add(Integer.parseInt(request.getParameter("siteFileId")), Integer.parseInt(request.getParameter("siteFolderId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        FileFolderDaoImpl.update(Integer.parseInt(request.getParameter("fileFolderId")), Integer.parseInt(request.getParameter("siteFileId")), Integer.parseInt(request.getParameter("siteFolderId")));
                        ...
                        break;
                    case 3:  //delete
                        fileFolderDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("form"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = FormDaoImpl.add(request.getParameter("formName"), request.getParameter("description"), request.getParameter("submissionEmail"), request.getParameter("submissionMethod"), request.getParameter("action"), Integer.parseInt(request.getParameter("resettable")), Integer.parseInt(request.getParameter("fileUpload")));
                        if (id != 0)
                        {
                    ...
                    case 2: //update            
                        ...
                        break;
                    case 3:  //delete
                        formDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("form_field"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = FormFieldDaoImpl.add(request.getParameter("fieldName"), request.getParameter("label"), request.getParameter("errorText"), request.getParameter("validationRegex"), Integer.parseInt(request.getParameter("rank")), request.getParameter("defaultValue"), request.getParameter("options"), request.getParameter("groupName"), Integer.parseInt(request.getParameter("optional")), Integer.parseInt(request.getParameter("formFieldTypeId")), Integer.parseInt(request.getParameter("formId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        FormFieldDaoImpl.update(Integer.parseInt(request.getParameter("formFieldId")), request.getParameter("fieldName"), request.getParameter("label"), request.getParameter("errorText"), request.getParameter("validationRegex"), Integer.parseInt(request.getParameter("rank")), request.getParameter("defaultValue"), request.getParameter("options"), request.getParameter("groupName"), Integer.parseInt(request.getParameter("optional")), Integer.parseInt(request.getParameter("formFieldTypeId")), Integer.parseInt(request.getParameter("formId")));
                        ...
                        break;
                    case 3:  //delete
                        formFieldDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("form_field_type"))
        {
            try
            {
                FormFieldTypeDao formFieldTypeDao = new FormFieldTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = FormFieldTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("inputType"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        FormFieldTypeDaoImpl.update(Integer.parseInt(request.getParameter("formFieldTypeId")), request.getParameter("typeName"), request.getParameter("inputType"));
                        ...
                        break;
                    case 3:  //delete
                        formFieldTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("image_type"))
        {
            try
            {
                ImageTypeDao imageTypeDao = new ImageTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ImageTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("description"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ImageTypeDaoImpl.update(Integer.parseInt(request.getParameter("imageTypeId")), request.getParameter("typeName"), request.getParameter("description"));
                        ...
                        break;
                    case 3:  //delete
                        imageTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = ItemDaoImpl.add(request.getParameter("itemName"), request.getParameter("description"), Double.parseDouble(request.getParameter("listPrice")), Double.parseDouble(request.getParameter("price")), request.getParameter("shortDescription"), Integer.parseInt(request.getParameter("adjustment")), request.getParameter("sku"), Integer.parseInt(request.getParameter("ratingSum")), Integer.parseInt(request.getParameter("voteCount")), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("itemStatus")), request.getParameter("locale"), Integer.parseInt(request.getParameter("itemTypeId")), Integer.parseInt(request.getParameter("itemBrandId")), Integer.parseInt(request.getParameter("metaTagId")), Integer.parseInt(request.getParameter("templateId")), Integer.parseInt(request.getParameter("vendorId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemDaoImpl.update(Integer.parseInt(request.getParameter("itemId")), request.getParameter("itemName"), request.getParameter("description"), Double.parseDouble(request.getParameter("listPrice")), Double.parseDouble(request.getParameter("price")), request.getParameter("shortDescription"), Integer.parseInt(request.getParameter("adjustment")), request.getParameter("sku"), Integer.parseInt(request.getParameter("ratingSum")), Integer.parseInt(request.getParameter("voteCount")), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("itemStatus")), request.getParameter("locale"), Integer.parseInt(request.getParameter("itemTypeId")), Integer.parseInt(request.getParameter("itemBrandId")), Integer.parseInt(request.getParameter("metaTagId")), Integer.parseInt(request.getParameter("templateId")), Integer.parseInt(request.getParameter("vendorId")));
                        ...
                        break;
                    case 3:  //delete
                        itemDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_attribute"))
        {
            try
            {
                ItemAttributeDao itemAttributeDao = new ItemAttributeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemAttributeDaoImpl.add(request.getParameter("key"), request.getParameter("value"), request.getParameter("locale"), Integer.parseInt(request.getParameter("itemAttributeTypeId")), Integer.parseInt(request.getParameter("itemId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemAttributeDaoImpl.update(Integer.parseInt(request.getParameter("itemAttributeId")), request.getParameter("key"), request.getParameter("value"), request.getParameter("locale"), Integer.parseInt(request.getParameter("itemAttributeTypeId")), Integer.parseInt(request.getParameter("itemId")));
                        ...
                        break;
                    case 3:  //delete
                        itemAttributeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_attribute_type"))
        {
            try
            {
                ItemAttributeTypeDao itemAttributeTypeDao = new ItemAttributeTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemAttributeTypeDaoImpl.add(request.getParameter("attributeName"), request.getParameter("description"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemAttributeTypeDaoImpl.update(Integer.parseInt(request.getParameter("itemAttributeTypeId")), request.getParameter("attributeName"), request.getParameter("description"));
                        ...
                        break;
                    case 3:  //delete
                        itemAttributeTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_availability"))
        {
            try
            {
                ItemAvailabilityDao itemAvailabilityDao = new ItemAvailabilityDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemAvailabilityDaoImpl.add(request.getParameter("type"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemAvailabilityDaoImpl.update(Integer.parseInt(request.getParameter("itemAvailabilityId")), request.getParameter("type"));
                        ...
                        break;
                    case 3:  //delete
                        itemAvailabilityDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_brand"))
        {
            try
            {
                ItemBrandDao itemBrandDao = new ItemBrandDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemBrandDaoImpl.add(request.getParameter("name"), request.getParameter("description"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemBrandDaoImpl.update(Integer.parseInt(request.getParameter("itemBrandId")), request.getParameter("name"), request.getParameter("description"));
                        ...
                        break;
                    case 3:  //delete
                        itemBrandDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_category"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = ItemCategoryDaoImpl.add(Integer.parseInt(request.getParameter("categoryId")), Integer.parseInt(request.getParameter("itemId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemCategoryDaoImpl.update(Integer.parseInt(request.getParameter("itemCategoryId")), Integer.parseInt(request.getParameter("categoryId")), Integer.parseInt(request.getParameter("itemId")));
                        ...
                        break;
                    case 3:  //delete
                        itemCategoryDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_discount"))
        {
            try
            {
                ItemDiscountDao itemDiscountDao = new ItemDiscountDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemDiscountDaoImpl.add(Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("discountId")), Integer.parseInt(request.getParameter("applyToOptions")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemDiscountDaoImpl.update(Integer.parseInt(request.getParameter("itemDiscountId")), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("discountId")), Integer.parseInt(request.getParameter("applyToOptions")));
                        ...
                        break;
                    case 3:  //delete
                        itemDiscountDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_file"))
        {
            try
            {
                ItemFileDao itemFileDao = new ItemFileDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemFileDaoImpl.add(request.getParameter("fileName"), request.getParameter("description"), request.getParameter("label"), Integer.parseInt(request.getParameter("hidden")), Integer.parseInt(request.getParameter("itemId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemFileDaoImpl.update(Integer.parseInt(request.getParameter("itemFileId")), request.getParameter("fileName"), request.getParameter("description"), request.getParameter("label"), Integer.parseInt(request.getParameter("hidden")), Integer.parseInt(request.getParameter("itemId")));
                        ...
                        break;
                    case 3:  //delete
                        itemFileDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_image"))
        {
            try
            {
                ItemImageDao itemImageDao = new ItemImageDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemImageDaoImpl.add(request.getParameter("imageName"), request.getParameter("thumbnailName"), request.getParameter("alternateText"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("itemId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemImageDaoImpl.update(Integer.parseInt(request.getParameter("itemImageId")), request.getParameter("imageName"), request.getParameter("thumbnailName"), request.getParameter("alternateText"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("itemId")));
                        ...
                        break;
                    case 3:  //delete
                        itemImageDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_location"))
        {
            try
            {
                ItemLocationDao itemLocationDao = new ItemLocationDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemLocationDaoImpl.add(request.getParameter("latitude"), request.getParameter("longitude"), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("addressId")), Integer.parseInt(request.getParameter("contactId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemLocationDaoImpl.update(Integer.parseInt(request.getParameter("itemLocationId")), request.getParameter("latitude"), request.getParameter("longitude"), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("addressId")), Integer.parseInt(request.getParameter("contactId")));
                        ...
                        break;
                    case 3:  //delete
                        itemLocationDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_option"))
        {
            try
            {
                ItemOptionDao itemOptionDao = new ItemOptionDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemOptionDaoImpl.add(request.getParameter("optionName"), request.getParameter("description"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemOptionDaoImpl.update(Integer.parseInt(request.getParameter("itemOptionId")), request.getParameter("optionName"), request.getParameter("description"));
                        ...
                        break;
                    case 3:  //delete
                        itemOptionDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_review"))
        {
            try
            {
                ItemReviewDao itemReviewDao = new ItemReviewDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ItemReviewDaoImpl.add(Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("rating")), Integer.parseInt(request.getParameter("helpfulYes")), Integer.parseInt(request.getParameter("helpfulNo")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemReviewDaoImpl.update(Integer.parseInt(request.getParameter("itemReviewId")), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("rating")), Integer.parseInt(request.getParameter("helpfulYes")), Integer.parseInt(request.getParameter("helpfulNo")));
                        ...
                        break;
                    case 3:  //delete
                        itemReviewDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("item_type"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = ItemTypeDaoImpl.add(request.getParameter("typeName"), Integer.parseInt(request.getParameter("rank")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ItemTypeDaoImpl.update(Integer.parseInt(request.getParameter("itemTypeId")), request.getParameter("typeName"), Integer.parseInt(request.getParameter("rank")));
                        ...
                        break;
                    case 3:  //delete
                        itemTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("knowledge_base"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = KnowledgeBaseDaoImpl.add(request.getParameter("knowledgeBaseName"), request.getParameter("description"), Integer.parseInt(request.getParameter("rank")), operatingDateFormat.parse(request.getParameter("lastModified")), Integer.parseInt(request.getParameter("latestTopic")), Integer.parseInt(request.getParameter("latestPost")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        KnowledgeBaseDaoImpl.update(Integer.parseInt(request.getParameter("knowledgeBaseId")), request.getParameter("knowledgeBaseName"), request.getParameter("description"), Integer.parseInt(request.getParameter("rank")), operatingDateFormat.parse(request.getParameter("lastModified")), Integer.parseInt(request.getParameter("latestTopic")), Integer.parseInt(request.getParameter("latestPost")));
                        ...
                        break;
                    case 3:  //delete
                        knowledgeBaseDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("locale"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = LocaleDaoImpl.add(request.getParameter("localeString"), request.getParameter("localeCharacterSet"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        LocaleDaoImpl.update(Integer.parseInt(request.getParameter("localeId")), request.getParameter("localeString"), request.getParameter("localeCharacterSet"));
                        ...
                        break;
                    case 3:  //delete
                        localeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("localized_string"))
        {
            try
            {
                LocalizedStringDao localizedStringDao = new LocalizedStringDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = LocalizedStringDaoImpl.add(Integer.parseInt(request.getParameter("locale")), request.getParameter("stringValue"), Integer.parseInt(request.getParameter("textStringId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        LocalizedStringDaoImpl.update(Integer.parseInt(request.getParameter("localizedStringId")), Integer.parseInt(request.getParameter("locale")), request.getParameter("stringValue"), Integer.parseInt(request.getParameter("textStringId")));
                        ...
                        break;
                    case 3:  //delete
                        localizedStringDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("mailinglist"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = MailinglistDaoImpl.add(request.getParameter("fullName"), request.getParameter("email"), Integer.parseInt(request.getParameter("listStatus")), Integer.parseInt(request.getParameter("userId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        MailinglistDaoImpl.update(Integer.parseInt(request.getParameter("mailinglistId")), request.getParameter("fullName"), request.getParameter("email"), Integer.parseInt(request.getParameter("listStatus")), Integer.parseInt(request.getParameter("userId")));
                        ...
                        break;
                    case 3:  //delete
                        mailinglistDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("meta_tag"))
        {
            try
            {
                MetaTagDao metaTagDao = new MetaTagDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = MetaTagDaoImpl.add(request.getParameter("title"), request.getParameter("description"), request.getParameter("keywords"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        MetaTagDaoImpl.update(Integer.parseInt(request.getParameter("metaTagId")), request.getParameter("title"), request.getParameter("description"), request.getParameter("keywords"));
                        ...
                        break;
                    case 3:  //delete
                        metaTagDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("option_availability"))
        {
            try
            {
                OptionAvailabilityDao optionAvailabilityDao = new OptionAvailabilityDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = OptionAvailabilityDaoImpl.add(Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("itemOptionId")), Integer.parseInt(request.getParameter("itemAvailabilityId")), Integer.parseInt(request.getParameter("availableQuantity")), Double.parseDouble(request.getParameter("price")), operatingDateFormat.parse(request.getParameter("availableFrom")), operatingDateFormat.parse(request.getParameter("availableTo")), Integer.parseInt(request.getParameter("maximumQuantity")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        OptionAvailabilityDaoImpl.update(Integer.parseInt(request.getParameter("optionAvailabilityId")), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("itemOptionId")), Integer.parseInt(request.getParameter("itemAvailabilityId")), Integer.parseInt(request.getParameter("availableQuantity")), Double.parseDouble(request.getParameter("price")), operatingDateFormat.parse(request.getParameter("availableFrom")), operatingDateFormat.parse(request.getParameter("availableTo")), Integer.parseInt(request.getParameter("maximumQuantity")));
                        ...
                        break;
                    case 3:  //delete
                        optionAvailabilityDao.remove(Integer.parseInt(request.getParameter("id")));
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        ...
                        break;
                    case 2: //update            
                        OrderDaoImpl.update(Integer.parseInt(request.getParameter("orderId")), operatingDateFormat.parse(request.getParameter("orderDate")), operatingDateFormat.parse(request.getParameter("shipDate")), request.getParameter("paymentMethod"), request.getParameter("purchaseOrder"), request.getParameter("transactionId"), Double.parseDouble(request.getParameter("amountBilled")), request.getParameter("paymentStatus"), request.getParameter("pendingReason"), request.getParameter("paymentType"), Double.parseDouble(request.getParameter("transactionFee")), request.getParameter("currencyCode"), request.getParameter("payerId"), Double.parseDouble(request.getParameter("subtotalAmount")), Double.parseDouble(request.getParameter("discountAmount")), Double.parseDouble(request.getParameter("taxAmount")), Double.parseDouble(request.getParameter("shippingAmount")), Double.parseDouble(request.getParameter("totalAmount")), Double.parseDouble(request.getParameter("refundAmount")), request.getParameter("notes"), Integer.parseInt(request.getParameter("orderStatus")), Integer.parseInt(request.getParameter("shippingId")), Integer.parseInt(request.getParameter("affiliateId")));
                        ...
                        break;
                    case 3:  //delete
                        orderDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("order_item"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = OrderItemDaoImpl.add(Integer.parseInt(request.getParameter("customerOrderId")), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("quantity")), request.getParameter("optionName"), Double.parseDouble(request.getParameter("unitPrice")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        OrderItemDaoImpl.update(Integer.parseInt(request.getParameter("orderItemId")), Integer.parseInt(request.getParameter("customerOrderId")), Integer.parseInt(request.getParameter("itemId")), Integer.parseInt(request.getParameter("quantity")), request.getParameter("optionName"), Double.parseDouble(request.getParameter("unitPrice")));
                        ...
                        break;
                    case 3:  //delete
                        orderItemDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("page"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = PageDaoImpl.add(request.getParameter("pageName"), request.getParameter("content"), Integer.parseInt(request.getParameter("pageStatus")), Integer.parseInt(request.getParameter("formId")), Integer.parseInt(request.getParameter("sliderId")), Integer.parseInt(request.getParameter("metaTagId")), Integer.parseInt(request.getParameter("templateId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        PageDaoImpl.update(Integer.parseInt(request.getParameter("pageId")), request.getParameter("pageName"), request.getParameter("content"), Integer.parseInt(request.getParameter("pageStatus")), Integer.parseInt(request.getParameter("formId")), Integer.parseInt(request.getParameter("sliderId")), Integer.parseInt(request.getParameter("metaTagId")), Integer.parseInt(request.getParameter("templateId")));
                        ...
                        break;
                    case 3:  //delete
                        pageDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("page_template"))
        {
            try
            {
                PageTemplateDao pageTemplateDao = new PageTemplateDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = PageTemplateDaoImpl.add(request.getParameter("name"), request.getParameter("markup"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        PageTemplateDaoImpl.update(Integer.parseInt(request.getParameter("pageTemplateId")), request.getParameter("name"), request.getParameter("markup"));
                        ...
                        break;
                    case 3:  //delete
                        pageTemplateDao.remove(Integer.parseInt(request.getParameter("id")));
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        ...
                        break;
                    case 2: //update            
                        PaypalDaoImpl.update(Integer.parseInt(request.getParameter("paypalId")), request.getParameter("payPalUrl"), request.getParameter("currencyCode"), request.getParameter("apiUsername"), request.getParameter("apiPassword"), request.getParameter("apiSignature"), request.getParameter("apiEndpoint"), Boolean.parseBoolean(request.getParameter("activeProfile")), request.getParameter("returnUrl"), request.getParameter("cancelUrl"), request.getParameter("paymentType"), request.getParameter("environment"));
                        ...
                        break;
                    case 3:  //delete
                        paypalDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("post_category"))
        {
            try
            {
                PostCategoryDao postCategoryDao = new PostCategoryDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = PostCategoryDaoImpl.add(request.getParameter("name"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        PostCategoryDaoImpl.update(Integer.parseInt(request.getParameter("postCategoryId")), request.getParameter("name"));
                        ...
                        break;
                    case 3:  //delete
                        postCategoryDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("recurring_payment"))
        {
            try
            {
                RecurringPaymentDao recurringPaymentDao = new RecurringPaymentDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = RecurringPaymentDaoImpl.add(Integer.parseInt(request.getParameter("cycleLength")), Integer.parseInt(request.getParameter("cyclePeriod")), Integer.parseInt(request.getParameter("totalCycles")), operatingDateFormat.parse(request.getParameter("startDate")), Integer.parseInt(request.getParameter("orderId")));
                        if (id != 0)
                        {
                    ...
                    case 2: //update            
                        ...
                        break;
                    case 3:  //delete
                        recurringPaymentDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("related_item"))
        {
            try
            {
                RelatedItemDao relatedItemDao = new RelatedItemDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = RelatedItemDaoImpl.add(Integer.parseInt(request.getParameter("item1")), Integer.parseInt(request.getParameter("item2")));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(u.getUserId().toString(), u.getUserName(), currentTime, "RelatedItem", id);
                        }

                        response.sendRedirect("admin/RelatedItemUI.jsp?SuccessMsg=Added RelatedItem Successfully!");
                        break;
                    case 2: //update            
                        RelatedItemDaoImpl.update(Integer.parseInt(request.getParameter("relatedItemId")), Integer.parseInt(request.getParameter("item1")), Integer.parseInt(request.getParameter("item2")));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "RelatedItem", Integer.parseInt(request.getParameter("relatedItemId")));
                        ...
                        break;
                    case 3:  //delete
                        relatedItemDao.remove(Integer.parseInt(request.getParameter("id")));
                        Database.RecordUserObjectDeletionAction(u.getUserId().toString(), u.getUserName(), currentTime, "RelatedItem", request.getParameter("id"));

                        response.sendRedirect("admin/RelatedItemUI.jsp?SuccessMsg=Deleted RelatedItem Successfully!");
                        break;
                    case 4:  //remove all records
                        relatedItemDao.removeAll();
                        Database.RecordUserObjectClearAction(u.getUserId().toString(), u.getUserName(), currentTime, "RelatedItem");
                        response.sendRedirect("admin/RelatedItemUI.jsp?SuccessMsg=Removed All Records Successfully!");
                        break;
                    default:
                        response.sendRedirect("admin/RelatedItemUI.jsp?ErrorMsg=Error editing RelatedItem, Invalid Action.");
                        break;
                }
            }
            catch (Exception e)
            {
                ...
                {
                    case 1:
                        response.sendRedirect("admin/RelatedItemUI.jsp?ErrorMsg=Error adding RelatedItem.");
                        break; //create
                    case 2:
                        response.sendRedirect("admin/RelatedItemUI.jsp?ErrorMsg=Error editing RelatedItem.");
                        break; //update                                                    
                    case 3:
                        response.sendRedirect("admin/RelatedItemUI.jsp?ErrorMsg=Error deleting RelatedItem.");
                        break; //delete                                                    
                    case 4:
                        response.sendRedirect("admin/RelatedItemUI.jsp?ErrorMsg=Error clearing RelatedItem.");
                        break; //clear                          
                    default:
                        response.sendRedirect("admin/RelatedItemUI.jsp?ErrorMsg=Unknown Error RelatedItem, possibly an invalid action.");
                        break;
                }
            }
        }
        ...
        if (request.getParameter("form").equals("resource_type"))
        {
            try
            {
                ResourceTypeDao resourceTypeDao = new ResourceTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ResourceTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("typeValue"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ResourceTypeDaoImpl.update(Integer.parseInt(request.getParameter("resourceTypeId")), request.getParameter("typeName"), request.getParameter("typeValue"));
                        ...
                        break;
                    case 3:  //delete
                        resourceTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("resource_url"))
        {
            try
            {
                ResourceUrlDao resourceUrlDao = new ResourceUrlDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ResourceUrlDaoImpl.add(request.getParameter("url"), Integer.parseInt(request.getParameter("templateId")), Integer.parseInt(request.getParameter("resourceTypeId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ResourceUrlDaoImpl.update(Integer.parseInt(request.getParameter("resourceUrlId")), request.getParameter("url"), Integer.parseInt(request.getParameter("templateId")), Integer.parseInt(request.getParameter("resourceTypeId")));
                        ...
                        break;
                    case 3:  //delete
                        resourceUrlDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("return_request"))
        {
            try
            {
                ReturnRequestDao returnRequestDao = new ReturnRequestDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ReturnRequestDaoImpl.add(Integer.parseInt(request.getParameter("quantity")), operatingDateFormat.parse(request.getParameter("requestDate")), request.getParameter("returnReason"), request.getParameter("requestedAction"), request.getParameter("notes"), Integer.parseInt(request.getParameter("requestStatus")), Integer.parseInt(request.getParameter("orderItemId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ReturnRequestDaoImpl.update(Integer.parseInt(request.getParameter("returnRequestId")), Integer.parseInt(request.getParameter("quantity")), operatingDateFormat.parse(request.getParameter("requestDate")), request.getParameter("returnReason"), request.getParameter("requestedAction"), request.getParameter("notes"), Integer.parseInt(request.getParameter("requestStatus")), Integer.parseInt(request.getParameter("orderItemId")));
                        ...
                        break;
                    case 3:  //delete
                        returnRequestDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("service"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = ServiceDaoImpl.add(request.getParameter("serviceName"), request.getParameter("description"), Integer.parseInt(request.getParameter("serviceStatus")), Integer.parseInt(request.getParameter("serviceChargeId")), Integer.parseInt(request.getParameter("serviceTypeId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ServiceDaoImpl.update(Integer.parseInt(request.getParameter("serviceId")), request.getParameter("serviceName"), request.getParameter("description"), Integer.parseInt(request.getParameter("serviceStatus")), Integer.parseInt(request.getParameter("serviceChargeId")), Integer.parseInt(request.getParameter("serviceTypeId")));
                        ...
                        break;
                    case 3:  //delete
                        serviceDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("service_charge"))
        {
            try
            {
                ServiceChargeDao serviceChargeDao = new ServiceChargeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = ServiceChargeDaoImpl.add(request.getParameter("chargeName"), request.getParameter("description"), request.getParameter("rate"), request.getParameter("units"), operatingDateFormat.parse(request.getParameter("date")), Integer.parseInt(request.getParameter("userServiceId")));
                        if (id != 0)
                        {
                    ...
                    case 2: //update            
                        ...
                        break;
                    case 3:  //delete
                        serviceChargeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("service_type"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = ServiceTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("desciption"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ServiceTypeDaoImpl.update(Integer.parseInt(request.getParameter("serviceTypeId")), request.getParameter("typeName"), request.getParameter("desciption"));
                        ...
                        break;
                    case 3:  //delete
                        serviceTypeDao.remove(Integer.parseInt(request.getParameter("id")));
            ...
            try
            {
                ...
                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        ...
                        break;
                    case 2: //update            
                        ShipmentDaoImpl.update(Integer.parseInt(request.getParameter("shipmentId")), operatingDateFormat.parse(request.getParameter("createdOn")), request.getParameter("trackingNumber"), Double.parseDouble(request.getParameter("totalWeight")), operatingDateFormat.parse(request.getParameter("shipDate")), operatingDateFormat.parse(request.getParameter("deliveryDate")), Integer.parseInt(request.getParameter("itemQuantity")), Integer.parseInt(request.getParameter("orderId")));
                        ...
                        break;
                    case 3:  //delete
                        shipmentDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("shipping"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = ShippingDaoImpl.add(request.getParameter("methodName"), Double.parseDouble(request.getParameter("quantity")), request.getParameter("unitOfMeasure"), Double.parseDouble(request.getParameter("ratePerUnitCost")), Double.parseDouble(request.getParameter("additionalCost")), Integer.parseInt(request.getParameter("stateProvinceId")), Integer.parseInt(request.getParameter("countryId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        ShippingDaoImpl.update(Integer.parseInt(request.getParameter("shippingId")), request.getParameter("methodName"), Double.parseDouble(request.getParameter("quantity")), request.getParameter("unitOfMeasure"), Double.parseDouble(request.getParameter("ratePerUnitCost")), Double.parseDouble(request.getParameter("additionalCost")), Integer.parseInt(request.getParameter("stateProvinceId")), Integer.parseInt(request.getParameter("countryId")));
                        ...
                        break;
                    case 3:  //delete
                        shippingDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = SiteDaoImpl.add(request.getParameter("siteName"), request.getParameter("domain"), Integer.parseInt(request.getParameter("mode")), request.getParameter("url"), request.getParameter("emailHost"), Integer.parseInt(request.getParameter("emailPort")), request.getParameter("emailUsername"), request.getParameter("emailPassword"), Integer.parseInt(request.getParameter("siteStatus")), request.getParameter("locale"), Integer.parseInt(request.getParameter("templateId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteDaoImpl.update(Integer.parseInt(request.getParameter("siteId")), request.getParameter("siteName"), request.getParameter("domain"), Integer.parseInt(request.getParameter("mode")), request.getParameter("url"), request.getParameter("emailHost"), Integer.parseInt(request.getParameter("emailPort")), request.getParameter("emailUsername"), request.getParameter("emailPassword"), Integer.parseInt(request.getParameter("siteStatus")), request.getParameter("locale"), Integer.parseInt(request.getParameter("templateId")));
                        ...
                        break;
                    case 3:  //delete
                        siteDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_attribute"))
        {
            try
            {
                SiteAttributeDao siteAttributeDao = new SiteAttributeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SiteAttributeDaoImpl.add(request.getParameter("attributeKey"), request.getParameter("attributeValue"), request.getParameter("attributeType"), Integer.parseInt(request.getParameter("siteId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteAttributeDaoImpl.update(Integer.parseInt(request.getParameter("siteAttributeId")), request.getParameter("attributeKey"), request.getParameter("attributeValue"), request.getParameter("attributeType"), Integer.parseInt(request.getParameter("siteId")));
                        ...
                        break;
                    case 3:  //delete
                        siteAttributeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_file"))
        {
            try
            {
                SiteFileDao siteFileDao = new SiteFileDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SiteFileDaoImpl.add(request.getParameter("fileName"), request.getParameter("description"), request.getParameter("label"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteFileDaoImpl.update(Integer.parseInt(request.getParameter("siteFileId")), request.getParameter("fileName"), request.getParameter("description"), request.getParameter("label"));
                        ...
                        break;
                    case 3:  //delete
                        siteFileDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_folder"))
        {
            try
            {
                SiteFolderDao siteFolderDao = new SiteFolderDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SiteFolderDaoImpl.add(request.getParameter("folderName"), request.getParameter("description"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("siteId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteFolderDaoImpl.update(Integer.parseInt(request.getParameter("siteFolderId")), request.getParameter("folderName"), request.getParameter("description"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("siteId")));
                        ...
                        break;
                    case 3:  //delete
                        siteFolderDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_image"))
        {
            try
            {
                SiteImageDao siteImageDao = new SiteImageDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SiteImageDaoImpl.add(request.getParameter("fileName"), request.getParameter("description"), request.getParameter("linkUrl"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("imageTypeId")), Integer.parseInt(request.getParameter("siteId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteImageDaoImpl.update(Integer.parseInt(request.getParameter("siteImageId")), request.getParameter("fileName"), request.getParameter("description"), request.getParameter("linkUrl"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("imageTypeId")), Integer.parseInt(request.getParameter("siteId")));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "SiteImage", Integer.parseInt(request.getParameter("siteImageId")));
                        ...
                        break;
                    case 3:  //delete
                        siteImageDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_item"))
        {
            try
            {
                SiteItemDao siteItemDao = new SiteItemDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SiteItemDaoImpl.add(Integer.parseInt(request.getParameter("siteId")), Integer.parseInt(request.getParameter("itemId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteItemDaoImpl.update(Integer.parseInt(request.getParameter("siteItemId")), Integer.parseInt(request.getParameter("siteId")), Integer.parseInt(request.getParameter("itemId")));
                        ...
                        break;
                    case 3:  //delete
                        siteItemDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_language"))
        {
            try
            {
                SiteLanguageDao siteLanguageDao = new SiteLanguageDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SiteLanguageDaoImpl.add(request.getParameter("languageName"), request.getParameter("locale"), Integer.parseInt(request.getParameter("rtl")), request.getParameter("flagFileName"), Integer.parseInt(request.getParameter("siteId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SiteLanguageDaoImpl.update(Integer.parseInt(request.getParameter("siteLanguageId")), request.getParameter("languageName"), request.getParameter("locale"), Integer.parseInt(request.getParameter("rtl")), request.getParameter("flagFileName"), Integer.parseInt(request.getParameter("siteId")));
                        ...
                        break;
                    case 3:  //delete
                        siteLanguageDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("site_page"))
        {
            try
            {
                SitePageDao sitePageDao = new SitePageDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SitePageDaoImpl.add(Integer.parseInt(request.getParameter("siteId")), Integer.parseInt(request.getParameter("pageId")));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(u.getUserId().toString(), u.getUserName(), currentTime, "SitePage", id);
                        }

                        response.sendRedirect("admin/SitePageUI.jsp?SuccessMsg=Added SitePage Successfully!");
                        break;
                    case 2: //update            
                        SitePageDaoImpl.update(Integer.parseInt(request.getParameter("sitePageId")), Integer.parseInt(request.getParameter("siteId")), Integer.parseInt(request.getParameter("pageId")));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "SitePage", Integer.parseInt(request.getParameter("sitePageId")));
                        response.sendRedirect("admin/SitePageUI.jsp?id=" + request.getParameter("sitePageId") + "&SuccessMsg=Updated SitePage Successfully!");
                        break;
                    case 3:  //delete
                        sitePageDao.remove(Integer.parseInt(request.getParameter("id")));
                        Database.RecordUserObjectDeletionAction(u.getUserId().toString(), u.getUserName(), currentTime, "SitePage", request.getParameter("id"));

                        response.sendRedirect("admin/SitePageUI.jsp?SuccessMsg=Deleted SitePage Successfully!");
                        break;
                    case 4:  //remove all records
                        sitePageDao.removeAll();
                        Database.RecordUserObjectClearAction(u.getUserId().toString(), u.getUserName(), currentTime, "SitePage");
                        response.sendRedirect("admin/SitePageUI.jsp?SuccessMsg=Removed All Records Successfully!");
                        break;
                    default:
                        response.sendRedirect("admin/SitePageUI.jsp?ErrorMsg=Error editing SitePage, Invalid Action.");
                        break;
                }
            }
            catch (Exception e)
            {
                ...
                {
                    case 1:
                        response.sendRedirect("admin/SitePageUI.jsp?ErrorMsg=Error adding SitePage.");
                        break; //create
                    case 2:
                        response.sendRedirect("admin/SitePageUI.jsp?ErrorMsg=Error editing SitePage.");
                        break; //update                                                    
                    case 3:
                        response.sendRedirect("admin/SitePageUI.jsp?ErrorMsg=Error deleting SitePage.");
                        break; //delete                                                    
                    case 4:
                        response.sendRedirect("admin/SitePageUI.jsp?ErrorMsg=Error clearing SitePage.");
                        break; //clear                          
                    default:
                        response.sendRedirect("admin/SitePageUI.jsp?ErrorMsg=Unknown Error SitePage, possibly an invalid action.");
                        break;
                }
            }
        }
        ...
        if (request.getParameter("form").equals("slider"))
        {
            try
            {
                SliderDao sliderDao = new SliderDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SliderDaoImpl.add(request.getParameter("sliderName"), Integer.parseInt(request.getParameter("sliderTypeId")), Integer.parseInt(request.getParameter("formId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SliderDaoImpl.update(Integer.parseInt(request.getParameter("sliderId")), request.getParameter("sliderName"), Integer.parseInt(request.getParameter("sliderTypeId")), Integer.parseInt(request.getParameter("formId")));
                        ...
                        break;
                    case 3:  //delete
                        sliderDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("slider_item"))
        {
            try
            {
                SliderItemDao sliderItemDao = new SliderItemDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SliderItemDaoImpl.add(request.getParameter("title"), request.getParameter("description"), request.getParameter("url"), request.getParameter("imageName"), request.getParameter("alternateText"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("sliderId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SliderItemDaoImpl.update(Integer.parseInt(request.getParameter("sliderItemId")), request.getParameter("title"), request.getParameter("description"), request.getParameter("url"), request.getParameter("imageName"), request.getParameter("alternateText"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("sliderId")));
                        ...
                        break;
                    case 3:  //delete
                        sliderItemDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("slider_type"))
        {
            try
            {
                SliderTypeDao sliderTypeDao = new SliderTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = SliderTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("code"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        SliderTypeDaoImpl.update(Integer.parseInt(request.getParameter("sliderTypeId")), request.getParameter("typeName"), request.getParameter("code"));
                        ...
                        break;
                    case 3:  //delete
                        sliderTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("state_province"))
        {
            try
            {
                StateProvinceDao stateProvinceDao = new StateProvinceDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = StateProvinceDaoImpl.add(request.getParameter("name"), request.getParameter("abbreviation"), Integer.parseInt(request.getParameter("countryId")));
                        if (id != 0)
                        {
                            Database.RecordUserObjectCreationAction(u.getUserId().toString(), u.getUserName(), currentTime, "StateProvince", id);
                        }

                        response.sendRedirect("admin/StateProvinceUI.jsp?SuccessMsg=Added StateProvince Successfully!");
                        break;
                    case 2: //update            
                        StateProvinceDaoImpl.update(Integer.parseInt(request.getParameter("stateProvinceId")), request.getParameter("name"), request.getParameter("abbreviation"), Integer.parseInt(request.getParameter("countryId")));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "StateProvince", Integer.parseInt(request.getParameter("stateProvinceId")));
                        ...
                        break;
                    case 3:  //delete
                        stateProvinceDao.remove(Integer.parseInt(request.getParameter("id")));
                        Database.RecordUserObjectDeletionAction(u.getUserId().toString(), u.getUserName(), currentTime, "StateProvince", request.getParameter("id"));

                        response.sendRedirect("admin/StateProvinceUI.jsp?SuccessMsg=Deleted StateProvince Successfully!");
                        break;
                    case 4:  //remove all records
                        stateProvinceDao.removeAll();
                        Database.RecordUserObjectClearAction(u.getUserId().toString(), u.getUserName(), currentTime, "StateProvince");
                        response.sendRedirect("admin/StateProvinceUI.jsp?SuccessMsg=Removed All Records Successfully!");
                        break;
                    default:
                        response.sendRedirect("admin/StateProvinceUI.jsp?ErrorMsg=Error editing StateProvince, Invalid Action.");
                        break;
                }
            }
            catch (Exception e)
            {
                ...
                {
                    case 1:
                        response.sendRedirect("admin/StateProvinceUI.jsp?ErrorMsg=Error adding StateProvince.");
                        break; //create
                    case 2:
                        response.sendRedirect("admin/StateProvinceUI.jsp?ErrorMsg=Error editing StateProvince.");
                        break; //update                                                    
                    case 3:
                        response.sendRedirect("admin/StateProvinceUI.jsp?ErrorMsg=Error deleting StateProvince.");
                        break; //delete                                                    
                    case 4:
                        response.sendRedirect("admin/StateProvinceUI.jsp?ErrorMsg=Error clearing StateProvince.");
                        break; //clear                          
                    default:
                        response.sendRedirect("admin/StateProvinceUI.jsp?ErrorMsg=Unknown Error StateProvince, possibly an invalid action.");
                        break;
                }
            }
        }
        ...
        if (request.getParameter("form").equals("store_info"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = StoreInfoDaoImpl.add(request.getParameter("logoTitle"), request.getParameter("logoImage"), request.getParameter("storeName"), request.getParameter("companyName"), request.getParameter("locale"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        StoreInfoDaoImpl.update(Integer.parseInt(request.getParameter("storeInfoId")), request.getParameter("logoTitle"), request.getParameter("logoImage"), request.getParameter("storeName"), request.getParameter("companyName"), request.getParameter("locale"));
                        ...
                        break;
                    case 3:  //delete
                        storeInfoDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("tax_rate"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = TaxRateDaoImpl.add(request.getParameter("taxCategory"), Double.parseDouble(request.getParameter("percentage")), request.getParameter("zipPostalCode"), Integer.parseInt(request.getParameter("stateProvinceId")), Integer.parseInt(request.getParameter("countryId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        TaxRateDaoImpl.update(Integer.parseInt(request.getParameter("taxRateId")), request.getParameter("taxCategory"), Double.parseDouble(request.getParameter("percentage")), request.getParameter("zipPostalCode"), Integer.parseInt(request.getParameter("stateProvinceId")), Integer.parseInt(request.getParameter("countryId")));
                        ...
                        break;
                    case 3:  //delete
                        taxRateDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("template"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = TemplateDaoImpl.add(request.getParameter("templateName"), request.getParameter("markup"), Integer.parseInt(request.getParameter("templateStatus")), Integer.parseInt(request.getParameter("templateTypeId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        TemplateDaoImpl.update(Integer.parseInt(request.getParameter("templateId")), request.getParameter("templateName"), request.getParameter("markup"), Integer.parseInt(request.getParameter("templateStatus")), Integer.parseInt(request.getParameter("templateTypeId")));
                        ...
                        break;
                    case 3:  //delete
                        templateDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("template_type"))
        {
            try
            {
                TemplateTypeDao templateTypeDao = new TemplateTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = TemplateTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("typeValue"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        TemplateTypeDaoImpl.update(Integer.parseInt(request.getParameter("templateTypeId")), request.getParameter("typeName"), request.getParameter("typeValue"));
                        ...
                        break;
                    case 3:  //delete
                        templateTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("text_string"))
        {
            try
            {
                TextStringDao textStringDao = new TextStringDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = TextStringDaoImpl.add(request.getParameter("key"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        TextStringDaoImpl.update(Integer.parseInt(request.getParameter("textStringId")), request.getParameter("key"));
                        ...
                        break;
                    case 3:  //delete
                        textStringDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("user"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = UserDaoImpl.add(request.getParameter("username"), request.getParameter("password"), request.getParameter("email"), request.getParameter("securityQuestion"), request.getParameter("securityAnswer"), operatingDateFormat.parse(request.getParameter("registerDate")), request.getParameter("imageURL"), Integer.parseInt(request.getParameter("status")), Integer.parseInt(request.getParameter("rank")), request.getParameter("webUrl"), Integer.parseInt(request.getParameter("itemBrandId")), Integer.parseInt(request.getParameter("userTypeId")), Integer.parseInt(request.getParameter("addressId")), Integer.parseInt(request.getParameter("contactId")), Integer.parseInt(request.getParameter("userGroupId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserDaoImpl.update(Integer.parseInt(request.getParameter("userId")), request.getParameter("username"), request.getParameter("password"), request.getParameter("email"), request.getParameter("securityQuestion"), request.getParameter("securityAnswer"), operatingDateFormat.parse(request.getParameter("registerDate")), request.getParameter("imageURL"), Integer.parseInt(request.getParameter("status")), Integer.parseInt(request.getParameter("rank")), request.getParameter("webUrl"), Integer.parseInt(request.getParameter("itemBrandId")), Integer.parseInt(request.getParameter("userTypeId")), Integer.parseInt(request.getParameter("addressId")), Integer.parseInt(request.getParameter("contactId")), Integer.parseInt(request.getParameter("userGroupId")));
        ...
        if (request.getParameter("form").equals("user_action"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = UserActionDaoImpl.add(operatingDateFormat.parse(request.getParameter("date")), request.getParameter("detail"), Integer.parseInt(request.getParameter("userActionTypeId")), Integer.parseInt(request.getParameter("userId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserActionDaoImpl.update(Integer.parseInt(request.getParameter("userActionId")), operatingDateFormat.parse(request.getParameter("date")), request.getParameter("detail"), Integer.parseInt(request.getParameter("userActionTypeId")), Integer.parseInt(request.getParameter("userId")));
                        ...
                        break;
                    case 3:  //delete
                        userActionDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("user_action_type"))
        {
            try
            {
                UserActionTypeDao userActionTypeDao = new UserActionTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = UserActionTypeDaoImpl.add(request.getParameter("typeName"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserActionTypeDaoImpl.update(Integer.parseInt(request.getParameter("userActionTypeId")), request.getParameter("typeName"));
                        ...
                        break;
                    case 3:  //delete
                        userActionTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("user_group"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = UserGroupDaoImpl.add(request.getParameter("groupName"), Integer.parseInt(request.getParameter("siteId")), Integer.parseInt(request.getParameter("discountId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserGroupDaoImpl.update(Integer.parseInt(request.getParameter("userGroupId")), request.getParameter("groupName"), Integer.parseInt(request.getParameter("siteId")), Integer.parseInt(request.getParameter("discountId")));
                        ...
                        break;
                    case 3:  //delete
                        userGroupDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("user_role"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = UserRoleDaoImpl.add(request.getParameter("userName"), request.getParameter("roleName"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserRoleDaoImpl.update(request.getParameter("userName"), request.getParameter("roleName"));
                        ...
                        break;
                    case 3:  //delete
                        userRoleDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("user_service"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = UserServiceDaoImpl.add(operatingDateFormat.parse(request.getParameter("startDate")), operatingDateFormat.parse(request.getParameter("endDate")), request.getParameter("details"), request.getParameter("contractUrl"), request.getParameter("deliverableUrl"), Double.parseDouble(request.getParameter("depositAmount")), Integer.parseInt(request.getParameter("userRank")), Integer.parseInt(request.getParameter("blogId")), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("serviceId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserServiceDaoImpl.update(Integer.parseInt(request.getParameter("userServiceId")), operatingDateFormat.parse(request.getParameter("startDate")), operatingDateFormat.parse(request.getParameter("endDate")), request.getParameter("details"), request.getParameter("contractUrl"), request.getParameter("deliverableUrl"), Double.parseDouble(request.getParameter("depositAmount")), Integer.parseInt(request.getParameter("userRank")), Integer.parseInt(request.getParameter("blogId")), Integer.parseInt(request.getParameter("userId")), Integer.parseInt(request.getParameter("serviceId")));
                        ...
                        break;
                    case 3:  //delete
                        userServiceDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("user_type"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = UserTypeDaoImpl.add(request.getParameter("typeName"), request.getParameter("description"), request.getParameter("redirectURL"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        UserTypeDaoImpl.update(Integer.parseInt(request.getParameter("userTypeId")), request.getParameter("typeName"), request.getParameter("description"), request.getParameter("redirectURL"));
                        Database.RecordUserObjectUpdateAction(u.getUserId().toString(), u.getUserName(), currentTime, "UserType", Integer.parseInt(request.getParameter("userTypeId")));
                        response.sendRedirect("admin/UserTypeUI.jsp?id=" + request.getParameter("userTypeId") + "&SuccessMsg=Updated UserType Successfully!");
                        break;
                    case 3:  //delete
                        userTypeDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("vendor"))
        {
            try
            {
                ...
                {
                    case 1: //create
                        int id = VendorDaoImpl.add(request.getParameter("vendorName"), request.getParameter("description"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("vendorStatus")), Integer.parseInt(request.getParameter("metaTagId")), Integer.parseInt(request.getParameter("templateId")), Integer.parseInt(request.getParameter("vendorTypeId")));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        VendorDaoImpl.update(Integer.parseInt(request.getParameter("vendorId")), request.getParameter("vendorName"), request.getParameter("description"), Integer.parseInt(request.getParameter("rank")), Integer.parseInt(request.getParameter("vendorStatus")), Integer.parseInt(request.getParameter("metaTagId")), Integer.parseInt(request.getParameter("templateId")), Integer.parseInt(request.getParameter("vendorTypeId")));
                        ...
                        break;
                    case 3:  //delete
                        vendorDao.remove(Integer.parseInt(request.getParameter("id")));
        ...
        if (request.getParameter("form").equals("vendor_type"))
        {
            try
            {
                VendorTypeDao vendorTypeDao = new VendorTypeDaoImpl();

                switch (Integer.parseInt(request.getParameter("action")))
                {
                    case 1: //create
                        int id = VendorTypeDaoImpl.add(request.getParameter("typeName"));
                        if (id != 0)
                        {
                        ...
                        break;
                    case 2: //update            
                        VendorTypeDaoImpl.update(Integer.parseInt(request.getParameter("vendorTypeId")), request.getParameter("typeName"));
                        ...
                        break;
                    case 3:  //delete
                        vendorTypeDao.remove(Integer.parseInt(request.getParameter("id")));
