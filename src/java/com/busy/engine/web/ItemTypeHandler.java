...
import com.busy.engine.service.ItemTypeServiceImpl;
...
@WebServlet("/rest/ItemType/*")
public class ItemTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ItemType resource with the following format: rest/ItemType/{Id:optional}";
    }
}
