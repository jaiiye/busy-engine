...
import com.busy.engine.service.DiscountServiceImpl;
...
public class DiscountHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for Discount resource with the following format: rest/Discount/{Id:optional}";
    }
}
