...
import com.busy.engine.service.FormFieldTypeServiceImpl;
...
@WebServlet("/rest/FormFieldType/*")
public class FormFieldTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for FormFieldType resource with the following format: rest/FormFieldType/{Id:optional}";
    }
}
