...
import com.busy.engine.service.UserActionTypeServiceImpl;
...
@WebServlet("/rest/UserActionType/*")
public class UserActionTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for UserActionType resource with the following format: rest/UserActionType/{Id:optional}";
    }
}
