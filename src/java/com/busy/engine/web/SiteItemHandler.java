...
import com.busy.engine.service.SiteItemServiceImpl;
...
@WebServlet("/rest/SiteItem/*")
public class SiteItemHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for SiteItem resource with the following format: rest/SiteItem/{Id:optional}";
    }
}
