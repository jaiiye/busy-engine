...
import com.busy.engine.service.PaypalServiceImpl;
...
@WebServlet("/rest/Paypal/*")
public class PaypalHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for Paypal resource with the following format: rest/Paypal/{Id:optional}";
    }
}
