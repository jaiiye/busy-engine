...
import com.busy.engine.service.MailinglistServiceImpl;
...
@WebServlet("/rest/Mailinglist/*")
public class MailinglistHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for Mailinglist resource with the following format: rest/Mailinglist/{Id:optional}";
    }
}
