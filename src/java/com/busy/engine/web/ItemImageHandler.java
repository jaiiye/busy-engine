...
import com.busy.engine.service.ItemImageServiceImpl;
...
@WebServlet("/rest/ItemImage/*")
public class ItemImageHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ItemImage resource with the following format: rest/ItemImage/{Id:optional}";
    }
}
