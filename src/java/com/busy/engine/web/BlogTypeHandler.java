...
import com.busy.engine.service.BlogTypeServiceImpl;
...
@WebServlet("/rest/BlogType/*")
public class BlogTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for BlogType resource with the following format: rest/BlogType/{Id:optional}";
    }
}
