...
import com.busy.engine.service.FileFolderServiceImpl;
...
@WebServlet("/rest/FileFolder/*")
public class FileFolderHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for FileFolder resource with the following format: rest/FileFolder/{Id:optional}";
    }
}
