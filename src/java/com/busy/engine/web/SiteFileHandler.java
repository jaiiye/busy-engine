...
import com.busy.engine.service.SiteFileServiceImpl;
...
@WebServlet("/rest/SiteFile/*")
public class SiteFileHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for SiteFile resource with the following format: rest/SiteFile/{Id:optional}";
    }
}
