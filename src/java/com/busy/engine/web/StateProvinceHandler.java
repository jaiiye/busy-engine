...
import com.busy.engine.service.StateProvinceServiceImpl;
...
@WebServlet("/rest/StateProvince/*")
public class StateProvinceHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for StateProvince resource with the following format: rest/StateProvince/{Id:optional}";
    }
}
