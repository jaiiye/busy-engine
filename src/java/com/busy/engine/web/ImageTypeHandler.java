...
import com.busy.engine.service.ImageTypeServiceImpl;
...
public class ImageTypeHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for ImageType resource with the following format: rest/ImageType/{Id:optional}";
    }
}
