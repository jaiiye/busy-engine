...
import com.busy.engine.service.ResourceTypeServiceImpl;
...
@WebServlet("/rest/ResourceType/*")
public class ResourceTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ResourceType resource with the following format: rest/ResourceType/{Id:optional}";
    }
}
