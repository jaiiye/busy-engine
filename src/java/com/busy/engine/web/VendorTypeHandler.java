...
import com.busy.engine.service.VendorTypeServiceImpl;
...
@WebServlet("/rest/VendorType/*")
public class VendorTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for VendorType resource with the following format: rest/VendorType/{Id:optional}";
    }
}
