...
import com.busy.engine.service.SiteEmailServiceImpl;
...
@WebServlet("/rest/SiteEmail/*")
public class SiteEmailHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for SiteEmail resource with the following format: rest/SiteEmail/{Id:optional}";
    }
}
