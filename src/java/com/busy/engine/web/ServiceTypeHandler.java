...
import com.busy.engine.service.ServiceTypeServiceImpl;
...
@WebServlet("/rest/ServiceType/*")
public class ServiceTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ServiceType resource with the following format: rest/ServiceType/{Id:optional}";
    }
}
