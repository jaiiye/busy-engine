...
import com.busy.engine.service.UserGroupServiceImpl;
...
public class UserGroupHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for UserGroup resource with the following format: rest/UserGroup/{Id:optional}";
    }
}
