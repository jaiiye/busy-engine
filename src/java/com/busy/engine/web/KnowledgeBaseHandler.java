...
import com.busy.engine.service.KnowledgeBaseServiceImpl;
...
@WebServlet("/rest/KnowledgeBase/*")
public class KnowledgeBaseHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for KnowledgeBase resource with the following format: rest/KnowledgeBase/{Id:optional}";
    }
}
