...
import com.busy.engine.service.LocaleServiceImpl;
...
public class LocaleHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for Locale resource with the following format: rest/Locale/{Id:optional}";
    }
}
