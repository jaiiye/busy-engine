...
import com.busy.engine.service.ItemReviewServiceImpl;
...
@WebServlet("/rest/ItemReview/*")
public class ItemReviewHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ItemReview resource with the following format: rest/ItemReview/{Id:optional}";
    }
}
