...
import com.busy.engine.service.CategoryServiceImpl;
...
public class CategoryHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for Category resource with the following format: rest/Category/{Id:optional}";
    }
}
