...
import com.busy.engine.service.PageServiceImpl;
...
public class PageHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for Page resource with the following format: rest/Page/{Id:optional}";
    }
}
