...
import com.busy.engine.service.TaxRateServiceImpl;
...
@WebServlet("/rest/TaxRate/*")
public class TaxRateHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for TaxRate resource with the following format: rest/TaxRate/{Id:optional}";
    }
}
