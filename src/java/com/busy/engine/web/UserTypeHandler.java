...
import com.busy.engine.service.UserTypeServiceImpl;
...
@WebServlet("/rest/UserType/*")
public class UserTypeHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for UserType resource with the following format: rest/UserType/{Id:optional}";
    }
}
