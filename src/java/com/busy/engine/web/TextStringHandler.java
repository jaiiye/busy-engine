...
import com.busy.engine.service.TextStringServiceImpl;
...
@WebServlet("/rest/TextString/*")
public class TextStringHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for TextString resource with the following format: rest/TextString/{Id:optional}";
    }
}
