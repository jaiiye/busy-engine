...
import com.busy.engine.service.EntityStatusServiceImpl;
...
@WebServlet("/rest/EntityStatus/*")
public class EntityStatusHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for EntityStatus resource with the following format: rest/EntityStatus/{Id:optional}";
    }
}
