...
import com.busy.engine.service.PostCategoryServiceImpl;
...
public class PostCategoryHandler extends AbstractHandler
{
    ...
    {
        return "Handles the requests for PostCategory resource with the following format: rest/PostCategory/{Id:optional}";
    }
}
