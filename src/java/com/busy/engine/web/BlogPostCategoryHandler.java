...
import com.busy.engine.service.BlogPostCategoryServiceImpl;
...
@WebServlet("/rest/BlogPostCategory/*")
public class BlogPostCategoryHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for BlogPostCategory resource with the following format: rest/BlogPostCategory/{Id:optional}";
    }
}
