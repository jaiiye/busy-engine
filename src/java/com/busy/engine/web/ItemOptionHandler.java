...
import com.busy.engine.service.ItemOptionServiceImpl;
...
@WebServlet("/rest/ItemOption/*")
public class ItemOptionHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ItemOption resource with the following format: rest/ItemOption/{Id:optional}";
    }
}
