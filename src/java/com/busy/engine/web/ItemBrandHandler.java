...
import com.busy.engine.service.ItemBrandServiceImpl;
...
@WebServlet("/rest/ItemBrand/*")
public class ItemBrandHandler extends AbstractHandler
{
    @Override
    ...
    {
        return "Handles the requests for ItemBrand resource with the following format: rest/ItemBrand/{Id:optional}";
    }
}
